...
public final class C3696yG {
    ...
    public final C0207Lh a(double d, double d2, long j) {
        double dCos;
        double dPow;
        if (!this.c) {
        ...
        C0207Lh c0207Lh = this.j;
        c0207Lh.a = f;
        c0207Lh.b = (float) dCos;
        return c0207Lh;
    }

    public C3696yG(float f) {
        this.a = Math.sqrt(1500.0d);
        this.b = 0.5d;
        this.c = false;
        this.j = new C0207Lh();
