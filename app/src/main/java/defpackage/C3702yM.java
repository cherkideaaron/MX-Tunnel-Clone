...
public final class C3702yM {
    public static final C3702yM k;
    ...
    static {
        float[] fArr = AbstractC0069Df.c;
        float fK0 = (float) ((AbstractC0069Df.k0() * 63.66197723675813d) / 100.0d);
        float[][] fArr2 = AbstractC0069Df.a;
        float f = fArr[0];
        float[] fArr3 = fArr2[0];
        float f2 = fArr3[0] * f;
        float f3 = fArr[1];
        ...
        float f10 = 1.0f / ((5.0f * fK0) + 1.0f);
        float f11 = f10 * f10 * f10 * f10;
        float f12 = 1.0f - f11;
        float fCbrt = (0.1f * f12 * f12 * ((float) Math.cbrt(fK0 * 5.0d))) + (f11 * fK0);
        float fK02 = AbstractC0069Df.k0() / fArr[1];
        double d2 = fK02;
        ...
        k = new C3702yM(fK02, ((fArr8[2] * 0.05f) + (fArr8[0] * 2.0f) + fArr8[1]) * fPow, fPow, fPow, f9, 1.0f, fArr6, fCbrt, (float) Math.pow(fCbrt, 0.25d), fSqrt);
    }

    public C3702yM(float f, float f2, float f3, float f4, float f5, float f6, float[] fArr, float f7, float f8, float f9) {
        this.f = f;
        this.a = f2;
        this.b = f3;
        this.c = f4;
