...
public final class C3683y3 {
    ...
    public final C3521v3 k;

    public C3683y3(TextView textView) {
        this.i = textView;
        this.j = textView.getContext();
        this.k = Build.VERSION.SDK_INT >= 29 ? new C3575w3() : new C3521v3();
    }
    ...
    public final int c(RectF rectF) {
        ...
        while (i3 <= i) {
            ...
            StaticLayout staticLayoutA = AbstractC3467u3.a(text, (Layout.Alignment) e(textView, "getLayoutAlignment", Layout.Alignment.ALIGN_NORMAL), Math.round(rectF.right), maxLines, this.i, this.h, this.k);
