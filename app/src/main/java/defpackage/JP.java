...
public abstract class JP {
    ...
    public static Status b(String str) {
        ...
        return listAsList.size() > 1 ? c((String) listAsList.get(0), (String) listAsList.get(1)) : c((String) listAsList.get(0), null);
    }

    public static Status c(String str, String str2) {
        int i;
        str.getClass();
        switch (str) {
            case "USER_CANCELLED":
        ...
        return i == 17499 ? str2 != null ? new Status(i, AbstractC3264qG.h(str, ":", str2)) : new Status(i, str) : new Status(i, str2);
    }
}
