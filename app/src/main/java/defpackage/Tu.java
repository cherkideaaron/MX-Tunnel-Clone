...
public class Tu extends C2 implements Menu {
    public final MenuC3511uu c;

    public Tu(Context context, MenuC3511uu menuC3511uu) {
        super(context);
        if (menuC3511uu == null) {
    ...
    public final MenuItem add(int i, int i2, int i3, CharSequence charSequence) {
        return f(this.c.add(i, i2, i3, charSequence));
    }
    ...
    public final MenuItem add(CharSequence charSequence) {
        return f(this.c.add(charSequence));
    }
