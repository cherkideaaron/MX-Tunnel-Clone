...
public class AlertDialogLayout extends AbstractC2527cs {
        ...
        if (mode2 != 1073741824) {
            ...
            for (int i7 = 0; i7 < childCount; i7++) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) c0557bs).width == -1) {
                        int i8 = ((LinearLayout.LayoutParams) c0557bs).height;
                        ((LinearLayout.LayoutParams) c0557bs).height = childAt3.getMeasuredHeight();
                        measureChildWithMargins(childAt3, iMakeMeasureSpec, 0, i2, 0);
                        ((LinearLayout.LayoutParams) c0557bs).height = i8;
                    }
                }
            }
        }
