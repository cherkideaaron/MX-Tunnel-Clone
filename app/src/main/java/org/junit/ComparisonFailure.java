...
public class ComparisonFailure extends AssertionError {
    ...
    public static class ComparisonCompactor {
        ...
        public String compact(String str) {
            ...
            String strL = AbstractC3264qG.l(AbstractC3264qG.n(strCompactPrefix), diffExtractor.expectedDiff(), strCompactSuffix);
            StringBuilder sbN = AbstractC3264qG.n(strCompactPrefix);
            sbN.append(diffExtractor.actualDiff());
            sbN.append(strCompactSuffix);
            return Assert.format(str, strL, sbN.toString());
        }
    }
