...
public class ParameterSignature {
    ...
    private <T extends Annotation> T findDeepAnnotation(Annotation[] annotationArr, Class<T> cls, int i) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            Annotation annotationFindDeepAnnotation = annotationArr[i2];
            if (cls.isInstance(annotationFindDeepAnnotation) || (annotationFindDeepAnnotation = findDeepAnnotation(annotationFindDeepAnnotation.annotationType().getAnnotations(), cls, i - 1)) != null) {
