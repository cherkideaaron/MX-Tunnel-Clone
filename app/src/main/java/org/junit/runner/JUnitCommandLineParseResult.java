    ...
    public String[] parseOptions(String... strArr) {
        ...
        while (true) {
            ...
            if (str.startsWith("--filter=") || str.equals("--filter")) {
                ...
                this.parserErrors.add(new CommandLineParserError(AbstractC3264qG.x("JUnit knows nothing about the ", str, " option")));
            }
            i++;
        }
        return new String[0];
    ...
    public void parseParameters(String[] strArr) {
        for (String str : strArr) {
            try {
                ...
                this.parserErrors.add(new IllegalArgumentException(AbstractC3264qG.x("Could not find class [", str, "]"), e));
            }
        }
    }
}
