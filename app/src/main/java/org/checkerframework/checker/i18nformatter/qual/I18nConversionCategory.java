...
public enum I18nConversionCategory {
    ...
    public static I18nConversionCategory stringToI18nConversionCategory(String str) {
        ...
        throw new IllegalArgumentException(AbstractC3264qG.w("Invalid format type ", lowerCase));
    }
    ...
    public String toString() {
        ...
        if (this.types == null) {
            ...
            StringJoiner stringJoinerB = N.B();
            for (Class<?> cls : this.types) {
                stringJoinerB.add(cls.getCanonicalName());
            }
            sb.append(stringJoinerB);
        }
        return sb.toString();
    }
}
