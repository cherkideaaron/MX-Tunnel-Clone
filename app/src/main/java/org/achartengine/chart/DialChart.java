...
public class DialChart extends RoundChart {
    ...
    public void draw(Canvas canvas, int i, int i2, int i3, int i4, Paint paint) {
        ...
        int iDrawLegend = this.mRenderer.isFitLegend() ? drawLegend(canvas, this.mRenderer, strArr, i, i5, i2, i3, i4, legendSize, paint, true) : legendSize;
        int i7 = (i2 + i4) - iDrawLegend;
        drawBackground(this.mRenderer, canvas, i, i2, i3, i4, paint, false, 0);
        int iMin = (int) (Math.min(Math.abs(i5 - i), Math.abs(i7 - i2)) * 0.35d * this.mRenderer.getScale());
        ...
        double d5 = f3;
        drawTicks(canvas, d, d2, angleMin, angleMax, this.mCenterX, this.mCenterY, d5, iMin, d3, paint, false);
        double d6 = f2;
        ...
        drawLegend(canvas, this.mRenderer, strArr, i, i5, i2, i3, i4, iDrawLegend, paint, false);
