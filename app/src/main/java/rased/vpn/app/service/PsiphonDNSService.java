...
import defpackage.AbstractC3744zA;
...
public class PsiphonDNSService extends Service implements SkStatus.StateListener {
    ...
    public static PsiphonTunnelManagerThread r;
    public static BA s;
    public static final String t = PsiphonDNSService.class.getName().concat("::restartservicebroadcast");
    public static final String u = PsiphonDNSService.class.getName().concat("::stopservicebroadcast");
    ...
    public C3492ub f;
    public String m;
    public final BinderC3582wA d = new BinderC3582wA(this, 0);
    public final C3690yA n = new C3690yA(0);
    public final B2 o = new B2(this, 3);
    ...
    public final void a() {
        ...
        NotificationChannel notificationChannelD = AbstractC2860iy.d(getString(R.string.channel_name_background));
        notificationChannelD.setDescription(getString(R.string.channel_description_background));
        notificationChannelD.enableLights(false);
        notificationChannelD.setLightColor(R.color.primary_color);
        notificationManager.createNotificationChannel(notificationChannelD);
        NotificationChannel notificationChannelX = AbstractC2860iy.x(getString(R.string.channel_name_status));
        notificationChannelX.setDescription(getString(R.string.channel_description_status));
        notificationChannelX.enableLights(true);
        notificationChannelX.setLightColor(R.color.primary_color);
        notificationManager.createNotificationChannel(notificationChannelX);
        NotificationChannel notificationChannelB = AbstractC2860iy.B(getString(R.string.channel_name_userreq));
        notificationChannelB.setDescription(getString(R.string.channel_description_userreq));
        notificationChannelB.setLightColor(R.color.primary_color);
    ...
    public final void e(String str, String str2, String str3, ConnectionStatus connectionStatus) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        int i = AbstractC3744zA.a[connectionStatus.ordinal()] != 1 ? R.drawable.ic_connecting : R.drawable.ic_connected;
        NotificationManager notificationManager = (NotificationManager) getSystemService("notification");
    ...
    public final void f() {
        r = new PsiphonTunnelManagerThread(this.b, this);
        p = new Date().getTime();
    ...
    public final synchronized void g() {
        try {
            p = 0L;
            PsiphonTunnelManagerThread psiphonTunnelManagerThread = r;
    ...
    public final int onStartCommand(Intent intent, int i, int i2) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            this.c.registerDefaultNetworkCallback(this.n);
        }
        IntentFilter intentFilter = new IntentFilter();
        intentFilter.addAction(u);
        intentFilter.addAction(t);
        AbstractC0115Ga.O(this, this.o, intentFilter);
        ...
        if (intent != null && "com.mxtunnel.pro.vpn:startTunnel".equals(intent.getAction())) {
            return 2;
        }
        ...
        new Thread(new RunnableC2705g5(this, 20)).start();
        return 2;
    }
