...
public class TunnelVpnSettings implements Parcelable {
    public static final Parcelable.Creator<TunnelVpnSettings> CREATOR = new Parcelable.Creator<TunnelVpnSettings>() { // from class: rased.vpn.app.service.vpn.TunnelVpnSettings.1
