...
public class XRayDNSService extends Service implements SkStatus.StateListener {
    ...
    public static TunnelManagerThread s;
    public static EO t;
    public static final String u = XRayDNSService.class.getName().concat("::restartservicebroadcast");
    public static final String v = XRayDNSService.class.getName().concat("::stopservicebroadcast");
    ...
    public C3492ub m;
    public String n;
    public final BinderC3582wA d = new BinderC3582wA(this, 2);
    public final C3690yA o = new C3690yA(2);
    public final B2 p = new B2(this, 5);
    ...
    public final void e(String str, String str2, String str3, ConnectionStatus connectionStatus) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        int i = DO.a[connectionStatus.ordinal()] != 1 ? R.drawable.ic_connecting : R.drawable.ic_connected;
        NotificationManager notificationManager = (NotificationManager) getSystemService("notification");
