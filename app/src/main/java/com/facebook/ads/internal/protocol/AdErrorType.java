...
public enum AdErrorType {
    ...
    INTERNAL_ERROR(AdError.INTERNAL_ERROR_CODE, A00(1620, 14, 59), true),
    CACHE_FAILURE_ERROR(AdError.CACHE_ERROR_CODE, A00(2124, 19, 114), true),
    START_BEFORE_INIT(2005, A00(2528, 36, 87), true),
    REMOTE_ADS_SERVICE_ERROR(AdError.REMOTE_ADS_SERVICE_ERROR, A00(343, 25, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT), true),
    ...
    BROKEN_MEDIA_ERROR(AdError.BROKEN_MEDIA_ERROR_CODE, A00(1020, 34, FacebookMediationAdapter.ERROR_FAILED_TO_PRESENT_AD), true),
    ...
    NO_MEDIAVIEW_IN_NATIVEAD(AdError.MEDIAVIEW_MISSING_ERROR_CODE, A00(1894, 32, 70), true),
    ...
    LOAD_CALLED_WHILE_SHOWING_AD(AdError.LOAD_CALLED_WHILE_SHOWING_AD, A00(FacebookMediationAdapter.ERROR_CREATE_NATIVE_AD_FROM_BID_PAYLOAD, 41, 30), true),
    CLEAR_TEXT_SUPPORT_NOT_ALLOWED(AdError.CLEAR_TEXT_SUPPORT_NOT_ALLOWED, A00(1277, 343, 52), true),
    INCORRECT_STATE_ERROR(AdError.INCORRECT_STATE_ERROR, A00(2492, 36, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT), true),
