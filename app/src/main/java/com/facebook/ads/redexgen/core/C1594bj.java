...
public final class C1594bj extends LinearLayout {
    public int A00;
    ...
    public C1594bj(C1901gi c1901gi, C1159Na c1159Na, int i) {
        super(c1901gi);
        this.A00 = -1;
        setOrientation(0);
        setGravity(17);
        ...
        int i2 = (int) (8.0f * f);
        this.A02 = (int) (1.0f * f);
        this.A04 = c1159Na.A05(false);
        this.A03 = P3.A02(this.A04, UserVerificationMethods.USER_VERIFY_PATTERN);
    ...
    */
    public final void A00(int r6) {
        ...
        L40:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C1594bj.A00(int):void");
    }
}
