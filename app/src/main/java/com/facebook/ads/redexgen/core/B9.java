...
public final class B9<K, V> extends AbstractC2353oX<K, V> {
    ...
    public static final AbstractC2353oX<Object, Object> A04 = new B9(null, new Object[0], 0);
     ...
     */
    public static <K, V> B9<K, V> A00(int n, Object[] alternatingKeysAndValues, C2351oV<K, V> builder) {
        Object obj;
        if (n == 0) {
            return (B9) A04;
        }
        if (n == 1) {
            AbstractC2278nJ.A03(Objects.requireNonNull(alternatingKeysAndValues[0]), Objects.requireNonNull(alternatingKeysAndValues[1]));
            return new B9<>(null, alternatingKeysAndValues, 1);
        }
        AbstractC2131ki.A01(n, alternatingKeysAndValues.length >> 1);
        Object objA02 = A02(alternatingKeysAndValues, n, BO.A03(n), 0);
        if (objA02 instanceof Object[]) {
            Object[] objArr = (Object[]) objA02;
            C2350oU c2350oU = (C2350oU) objArr[2];
            if (builder == null) {
                throw c2350oU.A02();
            }
            builder.A01 = c2350oU;
        ...
        if (size == 1) {
            ...
            if (hashTableObject instanceof byte[]) {
                ...
                if (strArr2[4].charAt(30) != strArr2[2].charAt(30)) {
                    ...
                    int iA00 = AbstractC2338oI.A00(key.hashCode());
                    while (true) {
                        int i = iA00 & mask;
                        int i2 = bArr[i];
                        String[] strArr4 = A03;
                ...
                int iA002 = AbstractC2338oI.A00(key.hashCode());
                while (true) {
                    int i3 = iA002 & mask2;
                    int h = sArr[i3] & 65535;
                    if (h == 65535) {
                ...
                int iA003 = AbstractC2338oI.A00(key.hashCode());
                while (true) {
                    int i4 = iA003 & mask3;
                    int h2 = iArr[i4];
                    if (h2 == -1) {
    ...
    public static Object A02(Object[] alternatingKeysAndValues, int n, int tableSize, int keyOffset) {
        if (n == 1) {
            AbstractC2278nJ.A03(Objects.requireNonNull(alternatingKeysAndValues[keyOffset]), Objects.requireNonNull(alternatingKeysAndValues[keyOffset ^ 1]));
            return null;
        }
        int h = tableSize - 1;
        C2350oU c2350oU = null;
        int i = -1;
        if (tableSize > 128) {
            if (tableSize <= 32768) {
                ...
                for (int i2 = 0; i2 < n; i2++) {
                    ...
                    AbstractC2278nJ.A03(value, objRequireNonNull);
                    int iA00 = AbstractC2338oI.A00(value.hashCode());
                    while (true) {
                        int i4 = iA00 & h;
                        ...
                        if (i5 == 65535) {
                            ...
                            if (zEquals) {
                                c2350oU = new C2350oU(value, objRequireNonNull, Objects.requireNonNull(alternatingKeysAndValues[i5 ^ 1]));
                ...
                return keyIndex == n ? hashTable : new Object[]{hashTable, Integer.valueOf(keyIndex), c2350oU};
            }
            ...
            while (i7 < n) {
                ...
                AbstractC2278nJ.A03(objRequireNonNull2, objRequireNonNull3);
                int outKeyIndex = AbstractC2338oI.A00(objRequireNonNull2.hashCode());
                while (true) {
                    ...
                    if (i10 == i) {
                        ...
                        if (objRequireNonNull2.equals(alternatingKeysAndValues[i10])) {
                            c2350oU = new C2350oU(objRequireNonNull2, objRequireNonNull3, Objects.requireNonNull(alternatingKeysAndValues[i10 ^ 1]));
            ...
            return i6 == n ? hashTable2 : new Object[]{hashTable2, Integer.valueOf(i6), c2350oU};
        }
        ...
        for (int i12 = 0; i12 < n; i12++) {
            ...
            AbstractC2278nJ.A03(objRequireNonNull4, objRequireNonNull5);
            int keyIndex2 = AbstractC2338oI.A00(objRequireNonNull4.hashCode());
            while (true) {
                ...
                if (previousKeyIndex == 255) {
                    ...
                    if (objRequireNonNull4.equals(alternatingKeysAndValues[previousKeyIndex])) {
                        c2350oU = new C2350oU(objRequireNonNull4, objRequireNonNull5, Objects.requireNonNull(alternatingKeysAndValues[previousKeyIndex ^ 1]));
        ...
        return i11 == n ? bArr : new Object[]{bArr, Integer.valueOf(i11), c2350oU};
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.B9 != com.google.common.collect.RegularImmutableMap<K, V> */
    @Override // com.facebook.ads.redexgen.core.AbstractC2353oX
    public final AbstractC2344oO<V> A0A() {
    ...
    public final BO<K> A0E() {
        ...
        return new BO<K>(this, c2a) { // from class: com.facebook.ads.redexgen.X.2B
            ...
            public final transient AbstractC2353oX<K, ?> A01;
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.B9 != com.google.common.collect.RegularImmutableMap<K, V> */
    @Override // com.facebook.ads.redexgen.core.AbstractC2353oX, java.util.Map
    @CheckForNull
