...
public abstract class AbstractC1547ay extends WebView {
    ...
    static {
        A0C();
        A02 = AbstractC1547ay.class.getSimpleName();
    }

    public AbstractC1547ay(Activity activity, C1901gi c1901gi) {
        super(activity);
        A0E(c1901gi);
    }

    public AbstractC1547ay(C1901gi c1901gi) {
        super(c1901gi);
        A0E(c1901gi);
    }
    ...
    public static void A0D(int i) {
        ...
        if (context != null) {
            context.A08().ABC(A0B(56, 8, 37), i, new C1314Te(A0B(35, 10, 3)));
        }
    }
