...
public final class C1341Uf {
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public final synchronized UW A06(int i, byte[] bArr, int i2, int[] iArr, int i3) throws IOException {
        C1340Ue c1340UeA00 = A00();
        int i4 = 1;
        if (i < 0) {
        ...
        while (true) {
            ...
            long j2 = c1340UeA00.A03[i5];
            long j3 = (i5 == c1340UeA00.A00 - i4 ? c1340UeA00.A01 : c1340UeA00.A03[i5 + 1]) - j2;
            if (j == -1) {
                j = j2;
            }
        ...
        if (i5 <= i) {
            return new UW(z ? UV.A04 : UV.A05, i, i, 0);
        }
        c1340UeA00.A02.seek(j);
        c1340UeA00.A02.read(bArr, i2, i6);
        return new UW(UV.A03, i, i5, i6);
    }
    ...
    public final synchronized boolean A09(byte[] bArr) throws IOException {
        ...
        A03(c1340UeA00.A00, c1340UeA00.A01);
        A04(c1340UeA00.A01, bArr);
        c1340UeA00.A02.getFD().sync();
        c1340UeA00.A00++;
        c1340UeA00.A01 += bArr.length;
        return true;
    }
    ...
    public C1341Uf(File file) throws IOException {
        this.A02 = file;
        if (!file.exists()) {
            this.A00 = C1340Ue.A03(file);
        } else if (!file.isFile()) {
            throw new IOException(String.format(Locale.US, A01(25, 32, 2), file.getCanonicalPath()));
        }
    }

    private C1340Ue A00() throws IOException {
        if (!this.A01) {
            if (this.A00 == null) {
                this.A00 = C1340Ue.A04(this.A02);
            }
            return this.A00;
        }
    ...
    private void A03(int i, long j) throws IOException {
        this.A00.A03[i] = j;
        this.A00.A02.seek(C1340Ue.A02(i));
