...
public final class C1045Io {
     ...
     */
    public static Pair<String, List<byte[]>> A02(C07084v c07084v) throws C3K {
        try {
            c07084v.A0g(16);
            long jA0O = c07084v.A0O();
            if (jA0O == 1482049860) {
            ...
            A0q[2] = "JoNevXQ";
            if (jA0O != 826496599) {
                AbstractC06934g.A07(A03(312, 17, 46), A03(492, 51, 65));
                return new Pair<>(A03(1189, 15, 45), null);
            }
            byte[] bArrA0l = c07084v.A0l();
            for (int iA09 = c07084v.A09() + 20; iA09 < bArrA0l.length - 4; iA09++) {
            ...
            throw C3K.A01(A03(267, 45, FacebookMediationAdapter.ERROR_MAPPING_NATIVE_ASSETS), null);
    ...
    public void A06() {
        AbstractC06853y.A01(this.A0b);
    }

    public static boolean A09(C07084v c07084v) throws C3K {
        try {
            ...
            c07084v.A0f(24);
            if (c07084v.A0P() == MatroskaExtractor.A0x.getMostSignificantBits()) {
                if (c07084v.A0P() == MatroskaExtractor.A0x.getLeastSignificantBits()) {
                    return true;
                }
            }
            return false;
    ...
    public final void A0E() {
        if (this.A0c != null) {
            C1009He c1009He = this.A0c;
            InterfaceC1008Hd interfaceC1008Hd = this.A0b;
            String[] strArr = A0q;
            ...
            c1009He.A05(interfaceC1008Hd, this.A0a);
        }
    }
    ...
    */
    public final void A0G(com.facebook.ads.redexgen.core.HA r20, int r21) throws com.facebook.ads.redexgen.core.C3K {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C1045Io.A0G(com.facebook.ads.redexgen.X.HA, int):void");
    }
}
