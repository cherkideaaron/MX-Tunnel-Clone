...
public final class C1849fs extends TL {
    ...
    static {
        ...
        A09 = new TF(1, A00(207, 8, 26), A00(89, 59, FacebookMediationAdapter.ERROR_MAPPING_NATIVE_ASSETS));
        ...
        A03 = new TF(7, A00(ModuleDescriptor.MODULE_VERSION, 4, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT), strA004);
        A02 = new TF(8, A00(148, 7, 8), strA002);
        A0B = new TF[]{A04, A09, A05, A0A, A08, A07, A06, A03, A02};
        A0C = TL.A02(A00(167, 6, 97), A0B);
    }

    public C1849fs(TH th) {
        super(th);
    }
