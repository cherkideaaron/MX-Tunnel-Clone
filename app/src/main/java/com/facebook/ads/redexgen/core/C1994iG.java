...
public final class C1994iG extends OU implements InterstitialAdExtendedListener {
    public static byte[] A01;
    public final C2015id A00;
    ...
    public C1994iG(String str, OW ow, C2015id c2015id) {
        super(str, ow);
        this.A00 = c2015id;
    }
    ...
    public final void onAdClicked(Ad ad) {
        super.A00.AEs(UserVerificationMethods.USER_VERIFY_ALL, this.A01, null);
    }
    ...
    public final void onRewardedAdCompleted() {
        super.A00.AEs(AuthApiStatusCodes.AUTH_API_INVALID_CREDENTIALS, this.A01, null);
    }

    @Override // com.facebook.ads.RewardedAdListener
    public final void onRewardedAdServerFailed() {
        super.A00.AEs(AuthApiStatusCodes.AUTH_API_CLIENT_ERROR, this.A01, null);
    }
