...
public class C0871Bs<V> extends C2L<K, V>.WrappedCollection.WrappedIterator implements ListIterator<V> {
    public final /* synthetic */ C0870Br A00;
    ...
    public C0871Bs(final C0870Br this$1) {
        super(this$1);
        this.A00 = this$1;
    }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Bs != com.google.common.collect.AbstractMapBasedMultimap<K, V>$WrappedList$WrappedListIterator */
    public C0871Bs(final C0870Br this$1, int index) {
