...
public final class C0905Dd extends ImageView implements InterfaceC1789eu {
    ...
    public final VI A03;
    public final AbstractC0919Dr A04;
    ...
    public C0905Dd(C1901gi c1901gi, VI vi) {
        super(c1901gi);
        this.A04 = new AbstractC0919Dr() { // from class: com.facebook.ads.redexgen.X.3V
        ...
        A05();
        setOnClickListener(new ViewOnClickListenerC1807fC(this));
    }
    ...
    public final void AKV(C0938Ek c0938Ek) {
        if (this.A00 != null) {
            ...
            AbstractC0919Dr abstractC0919Dr = this.A04;
            String[] strArr = A06;
