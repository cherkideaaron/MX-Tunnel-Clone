...
public final class C07074u {
    ...
    public C07074u(byte[] bArr) {
        this(bArr, bArr.length);
    }

    public C07074u(byte[] bArr, int i) {
        this.A00 = bArr;
        this.A02 = i;
    }

    private void A00() {
        AbstractC06853y.A08(this.A03 >= 0 && (this.A03 < this.A02 || (this.A03 == this.A02 && this.A01 == 0)));
    }
    ...
    public final long A05(int i) {
        if (i > 32) {
            return C5C.A0N(A04(i - 32), A04(32));
        }
        long jA0M = C5C.A0M(A04(i));
        String[] strArr = A04;
    ...
    public final void A0B(int i, int i2) {
        ...
        int i3 = 65280 >> remainingBitsToRead4;
    ...
    public final void A0C(C07084v c07084v) {
        A0E(c07084v.A0l(), c07084v.A0A());
        A08(c07084v.A09() * 8);
    }
    ...
    public final boolean A0H() {
        boolean returnValue = (this.A00[this.A03] & (UserVerificationMethods.USER_VERIFY_PATTERN >> this.A01)) != 0;
        A07();
        return returnValue;
    }
}
