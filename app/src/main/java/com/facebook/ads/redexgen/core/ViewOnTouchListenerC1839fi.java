...
public class ViewOnTouchListenerC1839fi implements View.OnTouchListener {
    ...
    public ViewOnTouchListenerC1839fi(TextureViewSurfaceTextureListenerC0900Cy textureViewSurfaceTextureListenerC0900Cy) {
