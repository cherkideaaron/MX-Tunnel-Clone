...
public enum EnumC1376Vq {
    ...
    A0D(7),
    A0J(100),
    A0H(FacebookMediationAdapter.ERROR_INVALID_SERVER_PARAMETERS),
    A0K(FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH),
    A0I(FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT),
    A06(200),
    A05(500),
    A0A(800),
    A09(801),
    ...
    public static EnumC1376Vq A00(int i) {
        for (EnumC1376Vq enumC1376Vq : values()) {
            if (enumC1376Vq.A00 == i) {
                return enumC1376Vq;
            }
        }
        return null;
