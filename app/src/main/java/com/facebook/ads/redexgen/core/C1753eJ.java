...
public final class C1753eJ {
    ...
    public C1753eJ(T8 t8, C1752eI c1752eI, VA va, Map<String, String> metricsData, String str) {
        this.A02 = t8;
        this.A05 = c1752eI;
        this.A03 = va;
        ...
        this.A08 = C1351Up.A2G(c1752eI.getContext());
    }

    private void A01() {
        HashMap map = new HashMap();
        map.put(A00(50, 10, 28), A00(60, 9, 113));
        A07(map);
    }
    ...
    private void A03() {
        HashMap map = new HashMap();
        map.put(A00(50, 10, 28), A00(23, 16, 53));
        A07(map);
    }

    private void A05(String str) {
        HashMap map = new HashMap();
        map.put(A00(83, 10, 86), String.valueOf(str));
        HashMap map2 = new HashMap();
        map2.put(A00(50, 10, 28), A00(69, 14, FacebookMediationAdapter.ERROR_INVALID_SERVER_PARAMETERS));
        map2.put(A00(39, 11, 46), AbstractC1412Xd.A01(map));
        A07(map2);
    }

    private void A06(String str, float f, float f2) {
        HashMap map = new HashMap();
        map.put(A00(12, 11, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT), str);
        map.put(A00(93, 1, 72), String.valueOf(f));
        map.put(A00(94, 1, 7), String.valueOf(f2));
        HashMap map2 = new HashMap();
        map2.put(A00(50, 10, 28), A00(0, 12, 98));
        map2.put(A00(39, 11, 46), AbstractC1412Xd.A01(map));
        A07(map2);
    }
    ...
    private void A07(Map<String, String> data) {
        ...
        data.putAll(AbstractC1754eK.A01(this.A02, this.A00, this.A01));
