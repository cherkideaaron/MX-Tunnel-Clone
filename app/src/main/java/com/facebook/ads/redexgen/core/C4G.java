...
public final class C4G implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public static EGLConfig A00(EGLDisplay eGLDisplay) {
        ...
        throw new C4E(C5C.A0n(A04(0, 67, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION), Boolean.valueOf(success), Integer.valueOf(iArr[0]), configs[0]));
    }
    ...
    public static EGLDisplay A02() {
        ...
        if (!eglInitialized) {
            throw new C4E(A04(140, 20, FacebookMediationAdapter.ERROR_WRONG_NATIVE_TYPE));
        }
    ...
    public final SurfaceTexture A07() {
        return (SurfaceTexture) AbstractC06853y.A01(this.A00);
    }
