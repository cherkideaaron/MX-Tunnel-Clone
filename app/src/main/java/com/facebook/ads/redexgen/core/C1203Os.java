...
public class C1203Os extends FrameLayout {
    public int A00;
    public int A01;
    public boolean A02;
    public boolean A03;
    ...
    public final InterfaceC1204Ot A06;
    ...
    public static final InterfaceC1205Ou A0A = new C1987i9();
     ...
     */
    public C1203Os(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        this.A04 = new Rect();
        this.A05 = new Rect();
        this.A06 = new C1988iA(this);
    ...
    public C1203Os(Context context) {
        this(context, null);
    }

    public C1203Os(Context context, AttributeSet attributeSet) {
