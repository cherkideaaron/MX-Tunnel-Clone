    ...
    */
    public static int A00(int r7) {
        /*
            ...
            r5 = 0
        L2:
            long[] r0 = com.facebook.ads.redexgen.core.C1047Iq.A05
            int r0 = r0.length
            if (r5 >= r0) goto L15
            long[] r0 = com.facebook.ads.redexgen.core.C1047Iq.A05
            r3 = r0[r5]
        ...
        L16:
            ...
            goto L2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C1047Iq.A00(int):int");
    }
    ...
    public final long A05(InterfaceC2252ms interfaceC2252ms, boolean z, boolean z2, int i) throws IOException {
        if (this.A01 == 0) {
            if (!interfaceC2252ms.AHR(this.A02, 0, 1, z)) {
                return -1L;
            }
        ...
        if (this.A00 != 1) {
            interfaceC2252ms.readFully(this.A02, 1, this.A00 - 1);
        }
        this.A01 = 0;
