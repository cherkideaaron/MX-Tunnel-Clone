...
public enum EnumC2487qp {
    ...
    public static EnumC2487qp[] valuesCustom() {
        EnumC2487qp[] enumC2487qpArrValuesCustom = values();
        if (A01[4].length() == 0) {
            throw new RuntimeException();
        }
        A01[5] = "kC8OQjnUJR";
        return (EnumC2487qp[]) enumC2487qpArrValuesCustom.clone();
    }
}
