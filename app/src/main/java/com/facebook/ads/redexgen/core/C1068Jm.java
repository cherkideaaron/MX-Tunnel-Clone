...
public final class C1068Jm {
    ...
    private SpannableString A04() {
        ...
        for (int length = 0; length < this.A06.size(); length++) {
            C1067Jl c1067Jl = this.A06.get(length);
            boolean z = c1067Jl.A02;
            int i3 = c1067Jl.A01;
            if (i3 != 8) {
                style = i3 == 7 ? 1 : 0;
                if (i3 != 7) {
    ...
    */
    public final com.facebook.ads.redexgen.core.C2411pT A08(int r10) {
        /*
            Method dump skipped, instructions count: 346
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C1068Jm.A08(int):com.facebook.ads.redexgen.X.pT");
    }
    ...
    public final void A09() {
        ...
        if (length > 0) {
            ...
            for (int i = length3 - 1; i >= 0; i--) {
                C1067Jl c1067Jl = this.A06.get(i);
                String[] strArr = A08;
                String str = strArr[2];
                ...
                int length5 = c1067Jl.A00;
                if (length5 == length) {
                    int length6 = c1067Jl.A00;
                    c1067Jl.A00 = length6 - 1;
                } else {
                    return;
                }
            }
    ...
    */
    public final void A0A() {
        ...
        L2a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C1068Jm.A0A():void");
    }
    ...
    public final void A0F(int i, boolean z) {
        this.A06.add(new C1067Jl(i, z, this.A05.length()));
    }
