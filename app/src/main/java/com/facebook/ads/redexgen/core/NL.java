...
public final class NL extends BroadcastReceiver {
    ...
    public NL(C07566r c07566r, Context context) {
        this.A01 = c07566r;
        this.A00 = context;
    }
    ...
    public final void A02() {
        ...
        intentFilter.addAction(A00(40, 40, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT) + this.A01.getUniqueId());
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        if (str3.length() == action4.length()) {
            ...
            if (str4.equals(action6)) {
                ...
                if (serializableExtra instanceof C0926Dy) {
                    if (this.A01.getListener() != null) {
                    ...
                    if (this.A02) {
                        ...
                        this.A01.A0a(((C0926Dy) serializableExtra).A01());
                    }
                    this.A01.setVisibility(0);
                    this.A01.A0e(EnumC1788et.A04, 1);
                    return;
                }
