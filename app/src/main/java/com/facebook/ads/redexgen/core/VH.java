...
public final class VH {
    ...
    static {
        ...
        A0i = new VH(A00(754, 25, 118), 7, A00(1786, 25, FacebookMediationAdapter.ERROR_REQUIRES_UNIFIED_NATIVE_ADS));
        ...
        A0W = new VH(A00(500, 10, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION), 15, A00(1532, 10, 49));
        A0I = new VH(A00(262, 16, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT), 16, A00(1286, 16, 15));
        A0r = new VH(A00(896, 14, 69), 17, A00(1925, 14, 99));
        A0q = new VH(A00(875, 21, FacebookMediationAdapter.ERROR_FACEBOOK_INITIALIZATION), 18, A00(1904, 21, 126));
        ...
        A0U = new VH(A00(447, 16, 27), 24, A00(1479, 16, FacebookMediationAdapter.ERROR_FACEBOOK_INITIALIZATION));
        ...
        A0u = new VH(A00(936, 10, FacebookMediationAdapter.ERROR_FAILED_TO_PRESENT_AD), 29, A00(1965, 10, 26));
        ...
        A0m = new VH(A00(833, 9, 4), 34, A00(1862, 9, FacebookMediationAdapter.ERROR_FACEBOOK_INITIALIZATION));
        A0l = new VH(A00(813, 20, FacebookMediationAdapter.ERROR_FAILED_TO_PRESENT_AD), 35, A00(1845, 17, 118));
        A0z = new VH(A00(1006, 18, 60), 36, A00(2035, 18, 57));
        A05 = new VH(A00(15, 18, 4), 37, A00(UserVerificationMethods.USER_VERIFY_ALL, 18, 31));
        A0A = new VH(A00(87, 17, 53), 38, A00(1085, 17, 79));
        A0C = new VH(A00(134, 33, 18), 39, A00(1132, 33, 66));
        A0B = new VH(A00(FacebookMediationAdapter.ERROR_FACEBOOK_INITIALIZATION, 30, 88), 40, A00(1102, 30, 97));
        A09 = new VH(A00(76, 11, 40), 41, A00(1165, 11, 77));
        A0E = new VH(A00(187, 23, 54), 42, A00(1211, 23, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION));
        A0F = new VH(A00(210, 26, 11), 43, A00(1234, 26, 120));
        A0K = new VH(A00(289, 14, 20), 44, A00(1313, 14, 3));
        A0P = new VH(A00(366, 20, FacebookMediationAdapter.ERROR_WRONG_NATIVE_TYPE), 45, A00(1398, 20, 55));
        ...
        A0b = new VH(A00(567, 40, FacebookMediationAdapter.ERROR_MAPPING_NATIVE_ASSETS), 55, A00(1599, 40, 116));
