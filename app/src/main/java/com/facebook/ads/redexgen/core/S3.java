...
public final class S3 implements NativeAdScrollViewApi {
    ...
    public S3(NativeAdScrollView nativeAdScrollView, Context context, NativeAdsManager nativeAdsManager, NativeAdScrollView.AdViewProvider adViewProvider, int i, NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes, int i2) throws Resources.NotFoundException {
        if (nativeAdsManager.isLoaded()) {
            if (type != null || adViewProvider != null || i > 0) {
                this.A06 = C1274Rp.A03(context);
                this.A04 = nativeAdsManager;
                this.A03 = nativeAdViewAttributes;
                this.A01 = adViewProvider;
                this.A02 = type;
                this.A00 = i2;
                C1929hA c1929hA = new C1929hA(this);
                this.A05 = new C1928h9(context);
                if (this.A02 == null) {
                    if (i > 0) {
