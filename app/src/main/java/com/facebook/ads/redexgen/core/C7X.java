...
public final class C7X extends AbstractC2021ik {
    ...
    public C7X(C1996iI c1996iI, String str) {
        super(c1996iI.A0B, str, A00(c1996iI));
        this.A01 = c1996iI;
    }

    public static C1995iH A00(C1996iI c1996iI) {
        return new C1995iH(c1996iI);
    }
    ...
    public final void A09() {
        this.A00 = new C2012iZ(this.A01, this, A04());
    ...
    public final void A0F(Ad ad, String str, AdExperienceType adExperienceType, boolean z) {
        ...
        this.A01.A08 = z;
        if (AbstractC1354Us.A09(this.A02) && AbstractC1354Us.A0B(this.A02)) {
