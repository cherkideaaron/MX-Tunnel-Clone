...
public abstract class AbstractC1748eE {
    ...
    public static BitmapDrawable A00(C1901gi c1901gi, String str) {
        try {
            ...
            if (overlayBm != null && (!A00 || A05(c1901gi, overlayBm))) {
                ...
                Resources resources = c1901gi.getResources();
                if (resources != null) {
                    DisplayMetrics displayMetrics = resources.getDisplayMetrics();
                    if (displayMetrics != null) {
                        overlayRepeat.setTargetDensity(displayMetrics.densityDpi);
                    } else {
                        A04(c1901gi, A02(0, 23, 41));
                    }
                } else {
                    A04(c1901gi, A02(23, 18, 119));
                }
                return overlayRepeat;
            }
            return null;
        } catch (Throwable th) {
            c1901gi.A08().ABC(A02(59, 3, 58), AbstractC1313Td.A1u, new C1314Te(th));
            return null;
        }
    }

    public static C1749eF A01(C1901gi c1901gi, String str) {
        BitmapDrawable bitmapDrawableA00;
        try {
            if (TextUtils.isEmpty(str) || (bitmapDrawableA00 = A00(c1901gi, str)) == null) {
                return null;
            }
            C1749eF c1749eF = new C1749eF(c1901gi);
            c1749eF.setBackground(bitmapDrawableA00);
            c1749eF.setClickable(false);
            c1749eF.setFocusable(false);
            return c1749eF;
        } catch (Throwable th) {
            c1901gi.A08().ABC(A02(59, 3, 58), AbstractC1313Td.A1u, new C1314Te(th));
            return null;
    ...
    public static void A04(C1901gi c1901gi, String str) {
        c1901gi.A08().ABC(A02(59, 3, 58), AbstractC1313Td.A1u, new C1314Te(str));
    }
    ...
    */
    public static boolean A05(com.facebook.ads.redexgen.core.C1901gi r4, android.graphics.Bitmap r5) {
        /*
            r3 = 0
        L1:
            int r0 = r5.getWidth()
        ...
        L36:
            r3 = 1
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.AbstractC1748eE.A02
            r0 = 2
            r1 = r2[r0]
            r0 = 3
            r0 = r2[r0]
        ...
        L4f:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.AbstractC1748eE.A05(com.facebook.ads.redexgen.X.gi, android.graphics.Bitmap):boolean");
    }
}
