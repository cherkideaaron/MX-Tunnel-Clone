...
public final class C3B extends ED {
    ...
    public C3B(C1901gi c1901gi) {
        this(c1901gi, null);
    }

    public C3B(C1901gi c1901gi, AttributeSet attributeSet) {
        this(c1901gi, attributeSet, 0);
    }

    public C3B(C1901gi c1901gi, AttributeSet attributeSet, int i) {
        super(c1901gi, attributeSet, i);
        this.A00 = new C0902Da(this);
