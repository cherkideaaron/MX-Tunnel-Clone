...
public final class L3 {
    ...
    public boolean A0A;
    public boolean A0B;
    public final InterfaceC1008Hd A0C;

    public L3(InterfaceC1008Hd interfaceC1008Hd) {
        this.A0C = interfaceC1008Hd;
    }
    ...
    public final void A06(byte[] bArr, int i, int i2) {
        if (this.A07) {
            ...
            if (i3 < i2) {
                ...
                this.A06 = (headerOffset & UserVerificationMethods.USER_VERIFY_PATTERN) != 0;
                this.A07 = false;
                return;
            }
            this.A00 += i2 - i;
