...
public final class C1554b5 extends FrameLayout {
    public int A00;
    public int A01;
    public final ImageView A02;
    public final ImageView A03;

    public C1554b5(C1901gi c1901gi) {
        super(c1901gi);
        this.A03 = new ImageView(c1901gi);
        this.A02 = new ImageView(c1901gi);
        A00();
    }

    public C1554b5(C1901gi c1901gi, AttributeSet attributeSet) {
        super(c1901gi, attributeSet);
        this.A03 = new ImageView(c1901gi, attributeSet);
        this.A02 = new ImageView(c1901gi, attributeSet);
        A00();
    }

    public C1554b5(C1901gi c1901gi, AttributeSet attributeSet, int i) {
        super(c1901gi, attributeSet, i);
        this.A03 = new ImageView(c1901gi, attributeSet, i);
        this.A02 = new ImageView(c1901gi, attributeSet, i);
        A00();
    }

    public C1554b5(C1901gi c1901gi, AttributeSet attributeSet, int i, int i2) {
        super(c1901gi, attributeSet, i, i2);
        this.A03 = new ImageView(c1901gi, attributeSet, i, i2);
        this.A02 = new ImageView(c1901gi, attributeSet, i, i2);
        A00();
    }
