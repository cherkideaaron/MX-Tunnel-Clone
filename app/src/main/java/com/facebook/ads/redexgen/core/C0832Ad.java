...
public final class C0832Ad implements List, Serializable, RandomAccess {
    public static byte[] A00 = null;
    public static final C0832Ad A01;
    ...
    public final <T> T[] toArray(T[] tArr) {
        C2475qY.A09(tArr, A03(115, 5, 5));
        return (T[]) AbstractC2477qa.A03(this, tArr);
    }
    ...
    public final boolean containsAll(Collection elements) {
        C2475qY.A09(elements, A03(127, 8, 126));
    ...
    public final List subList(int fromIndex, int toIndex) {
        ...
        throw new IndexOutOfBoundsException(A03(135, 11, FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH) + fromIndex + A03(0, 11, 17) + toIndex);
    }

    public final String toString() {
        return A03(113, 2, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION);
    }
}
