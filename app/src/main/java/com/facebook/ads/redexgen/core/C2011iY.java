...
public final class C2011iY implements T5 {
    public long A00;
    ...
    public C2011iY(C1901gi c1901gi, InterstitialAd interstitialAd, String str) {
        this(c1901gi, interstitialAd, str, new C2020ij());
    }

    public C2011iY(C1901gi c1901gi, InterstitialAd interstitialAd, String str, U3 u3) {
        this.A0A = c1901gi;
        this.A0B = str;
    ...
    public final void A0D(InterstitialAd interstitialAd) {
        if (interstitialAd == null && !C1351Up.A0u(this.A0A)) {
            return;
        }
        this.A01 = interstitialAd;
    }
