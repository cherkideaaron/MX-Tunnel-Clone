...
public final class C1397Wl {
    public static C1397Wl A03;
    ...
    public final C1396Wk A01 = new C1396Wk();
    ...
    public C1397Wl(T8 t8) {
        this.A00 = t8;
    }

    public static C1397Wl A00(T8 t8) {
        if (A03 == null) {
            A03 = new C1397Wl(t8);
        }
        return A03;
    ...
    public final int A0A(String str) {
        ...
        A05[3] = "fotbcTaHfC";
        return c1396Wk.A03(t8, strA01, 0);
    }
                ...
                try {
                    ...
                    if (!A08(str, clientToken)) {
                        ...
                        if (!jSONObject.has(strA01)) {
                            ...
                            if (System.currentTimeMillis() - jSONObject.getLong(strA01) < C1351Up.A02(this.A00)) {
    ...
    public final void A0C(String str) throws JSONException {
        try {
            ...
            JSONObject jSONObject = placementJSON.getJSONObject(0).getJSONObject(A01(16, 4, FacebookMediationAdapter.ERROR_CREATE_NATIVE_AD_FROM_BID_PAYLOAD));
    ...
    public final boolean A0F(String str) {
        return !C1351Up.A1A(this.A00) && (str.equals(AdPlacementType.BANNER.toString()) || str.equals(AdPlacementType.MEDIUM_RECTANGLE.toString()));
    }
}
