...
public final class XC {
    ...
    public static int A00(C1901gi c1901gi, int i) {
        return WN.A00(c1901gi).getInt(A01(0, 21, 52), i);
    }

    public static String A02(C1901gi c1901gi, String str) {
        int iA00 = A00(c1901gi, -1);
        if (iA00 == -1) {
            return null;
        }
        try {
    ...
    public static String A03(String str, String str2, Object obj) throws JSONException {
        ...
        if (str != null) {
            ...
            String extraData = A01(42, 5, FacebookMediationAdapter.ERROR_REQUIRES_UNIFIED_NATIVE_ADS);
    ...
    public static boolean A05(String str) throws JSONException {
        return str != null && new JSONObject(new JSONObject(str).getJSONObject(A01(42, 5, FacebookMediationAdapter.ERROR_REQUIRES_UNIFIED_NATIVE_ADS)).optString(A01(32, 10, 55), A01(61, 2, 93))).optBoolean(A01(21, 11, 10), false);
    }

    public final InterstitialAd A06(C1901gi c1901gi, String str, String str2) {
        if (c1901gi == null) {
            return null;
        }
        try {
            InterstitialAd interstitialAd = new InterstitialAd(c1901gi, str);
    ...
    public final RewardedVideoAd A07(C1901gi c1901gi, String str, String str2) {
        if (c1901gi == null) {
            return null;
        }
        try {
            RewardedVideoAd rewardedVideoAd = new RewardedVideoAd(c1901gi, str);
    ...
    public final void A08(C1901gi c1901gi, boolean z) {
        int i = 0;
        String strA01 = A01(0, 21, 52);
        if (!z) {
            int lastNonChainedAds = WN.A00(c1901gi).getInt(strA01, 0);
            i = lastNonChainedAds + 1;
        }
        WN.A00(c1901gi).edit().putInt(strA01, i).apply();
    }

    public final boolean A09(C1901gi c1901gi, String str, int i) {
        if (i <= 0) {
            return false;
        }
        try {
            if (!A05(str)) {
                int lastNonChainedAds = A00(c1901gi, i - 1);
