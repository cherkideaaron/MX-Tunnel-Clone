...
public final class U4 {
    ...
    public static long A01(T8 t8, String str) {
        try {
            ...
            if (A03.compareAndSet(false, true)) {
                t8.A08().ABC(A02(144, 7, 94), AbstractC1313Td.A1E, new C1314Te(e));
            }
            return -1L;
        }
    }
    ...
    public static String A03(Context context) throws NoSuchFieldException {
        try {
            Field buildType = Class.forName(context.getPackageName() + A02(0, 12, 116)).getDeclaredField(A02(37, 10, FacebookMediationAdapter.ERROR_INVALID_SERVER_PARAMETERS));
    ...
    public static String A04(Context context) throws NoSuchFieldException {
        try {
            Field buildType = Class.forName(context.getPackageName() + A02(0, 12, 116)).getDeclaredField(A02(71, 5, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT));
    ...
    public static String A05(T8 t8, String str) throws JSONException {
        ...
        A07(t8, jSONObject, A02(FacebookMediationAdapter.ERROR_REQUIRES_UNIFIED_NATIVE_ADS, 18, 51), String.valueOf(AbstractC1400Wp.A00(t8)));
        A07(t8, jSONObject, A02(161, 13, 60), String.valueOf(A09(t8)));
        A07(t8, jSONObject, A02(133, 11, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION), A04(t8));
        A07(t8, jSONObject, A02(123, 10, 27), A03(t8));
        return jSONObject.toString();
    }

    public static void A07(T8 t8, JSONObject jSONObject, String str, String str2) throws JSONException {
        try {
            jSONObject.put(str, str2);
        } catch (JSONException e) {
            if (t8.A05().AAO()) {
                Log.e(A02, A02(47, 24, FacebookMediationAdapter.ERROR_MAPPING_NATIVE_ASSETS), e);
            }
        }
    }
    ...
    public static boolean A08() {
        ...
        if (!str.contains(strA02) && !Build.FINGERPRINT.startsWith(A02(195, 7, 28))) {
            ...
            if (!str2.contains(strA022) && !Build.MODEL.contains(A02(76, 8, 16))) {
                ...
                if (!str3.contains(A02(12, 25, 30)) && !Build.MANUFACTURER.contains(A02(84, 10, FacebookMediationAdapter.ERROR_INVALID_SERVER_PARAMETERS)) && ((!Build.BRAND.startsWith(strA02) || !Build.DEVICE.startsWith(strA02)) && !strA022.equals(Build.PRODUCT))) {
                    return false;
                }
            }
        }
