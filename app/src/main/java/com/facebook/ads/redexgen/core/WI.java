...
public abstract class WI {
    ...
    public static String A02(T8 t8) {
        String loggingEndpointPrefix = C1351Up.A0X(t8);
    ...
    public static String A04(T8 t8) {
        String syncEndpointPrefix = C1351Up.A0Y(t8);
        StringBuilder sbAppend = new StringBuilder().append(A07(t8, syncEndpointPrefix));
        String syncEndpointPrefix2 = A00(36, 11, FacebookMediationAdapter.ERROR_NULL_CONTEXT);
