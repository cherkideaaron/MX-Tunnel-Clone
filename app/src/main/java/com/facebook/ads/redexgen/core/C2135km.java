...
public final class C2135km {
    public static byte[] A03;
    public File A00;
    public RandomAccessFile A01;
    public final InterfaceC1110Lc A02;
     ...
     */
    public final synchronized void A07() throws C2129kg {
        if (A09()) {
            return;
        }
        A06();
        ...
        if (!this.A00.renameTo(file)) {
            throw new C2129kg(A00(166, 20, 3) + this.A00 + A00(44, 4, 115) + file + A00(14, 16, 47));
        }
        this.A00 = file;
        try {
            this.A01 = new RandomAccessFile(this.A00, A00(UserVerificationMethods.USER_VERIFY_HANDPRINT, 1, 61));
        } catch (IOException e) {
            throw new C2129kg(A00(123, 14, 50) + this.A00 + A00(0, 14, 69), e);
        }
    }

    public C2135km(File file, InterfaceC1110Lc interfaceC1110Lc) throws C2129kg {
        try {
            if (interfaceC1110Lc != null) {
                this.A02 = interfaceC1110Lc;
                File directory = file.getParentFile();
                C1113Lf.A06(directory);
                boolean zExists = file.exists();
                this.A00 = zExists ? file : new File(file.getParentFile(), file.getName() + A00(48, 9, 95));
                this.A01 = new RandomAccessFile(this.A00, zExists ? A00(UserVerificationMethods.USER_VERIFY_HANDPRINT, 1, 61) : A00(257, 2, 66));
                return;
            }
            throw new NullPointerException();
        } catch (IOException e) {
            throw new C2129kg(A00(186, 17, 54) + file + A00(0, 14, 69), e);
        }
    }
    ...
    public final synchronized int A03() throws C2129kg {
        try {
        } catch (IOException e) {
            throw new C2129kg(A00(137, 29, 78) + this.A00, e);
        }
    ...
    public final synchronized void A05() throws C2129kg {
        try {
            this.A01.setLength(0L);
        } catch (IOException e) {
            throw new C2129kg(A00(57, 16, 62), e);
        }
    }

    public final synchronized void A06() throws C2129kg {
        try {
            this.A01.close();
            this.A02.AKR(this.A00);
        } catch (IOException e) {
            throw new C2129kg(A00(FacebookMediationAdapter.ERROR_FACEBOOK_INITIALIZATION, 19, 93) + this.A00, e);
        }
    }

    public final synchronized void A08(byte[] bArr, int i) throws C2129kg {
        try {
            if (!A09()) {
                this.A01.seek(A03());
                this.A01.write(bArr, 0, i);
            } else {
                throw new C2129kg(A00(73, 31, 71) + this.A00 + A00(30, 14, 126));
            }
        } catch (IOException e) {
            throw new C2129kg(String.format(Locale.US, A00(203, 53, 72), Integer.valueOf(i), this.A01, Integer.valueOf(bArr.length)), e);
        }
    }
