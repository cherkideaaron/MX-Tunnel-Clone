...
public abstract class AbstractC1231Px {
    ...
    public static final C1230Pw A02;
    ...
    static {
        A01();
        A02 = new C1979hz() { // from class: com.facebook.ads.redexgen.X.7T
            public static byte[] A00;
            ...
            @Override // com.facebook.ads.redexgen.core.C1230Pw
            public final void A02(ViewParent viewParent, View view) {
                try {
                    viewParent.onStopNestedScroll(view);
                } catch (AbstractMethodError e) {
                    Log.e(A00(389, 16, FacebookMediationAdapter.ERROR_INVALID_SERVER_PARAMETERS), A00(378, 11, 90) + viewParent + A00(323, 55, 96), e);
                }
            }
            ...
            public final void A03(ViewParent viewParent, View view, int i, int i2, int i3, int i4) {
                try {
                    ...
                    Log.e(A00(389, 16, FacebookMediationAdapter.ERROR_INVALID_SERVER_PARAMETERS), A00(378, 11, 90) + viewParent + A00(157, 51, 53), e);
                }
            }
            ...
            public final void A04(ViewParent viewParent, View view, int i, int i2, int[] iArr) {
                try {
                    ...
                    Log.e(A00(389, 16, FacebookMediationAdapter.ERROR_INVALID_SERVER_PARAMETERS), A00(378, 11, 90) + viewParent + A00(FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT, 54, 8), e);
                }
            }
            ...
            public final void A05(ViewParent viewParent, View view, View view2, int i) {
                try {
                    ...
                    Log.e(A00(389, 16, FacebookMediationAdapter.ERROR_INVALID_SERVER_PARAMETERS), A00(378, 11, 90) + viewParent + A00(208, 59, 114), e);
                }
            }
            ...
            public final boolean A06(ViewParent viewParent, View view, float f, float f2) {
                try {
                    ...
                    Log.e(A00(389, 16, FacebookMediationAdapter.ERROR_INVALID_SERVER_PARAMETERS), A00(378, 11, 90) + viewParent + A00(50, 53, 25), e);
                    return false;
                }
            }
            ...
            public final boolean A07(ViewParent viewParent, View view, float f, float f2, boolean z) {
                try {
                    ...
                    Log.e(A00(389, 16, FacebookMediationAdapter.ERROR_INVALID_SERVER_PARAMETERS), A00(378, 11, 90) + viewParent + A00(0, 50, 79), e);
                    return false;
                }
            }
            ...
            public final boolean A08(ViewParent viewParent, View view, View view2, int i) {
                try {
                    ...
                    Log.e(A00(389, 16, FacebookMediationAdapter.ERROR_INVALID_SERVER_PARAMETERS), A00(378, 11, 90) + viewParent + A00(267, 56, 74), e);
                    return false;
                }
            }
        };
    ...
    public static void A05(ViewParent viewParent, View view, View view2, int i, int i2) {
        ...
        if (i2 == 0) {
            ...
            if (A01[1].length() != 12) {
                ...
                c1230Pw.A05(viewParent, view, view2, i);
                return;
            }
            throw new RuntimeException();
        }
    ...
    public static boolean A08(ViewParent viewParent, View view, View view2, int i, int i2) {
        ...
        if (i2 == 0) {
            boolean zA08 = A02.A08(viewParent, view, view2, i);
            if (A01[1].length() == 12) {
                throw new RuntimeException();
            }
