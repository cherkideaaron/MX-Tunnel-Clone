...
public class PF<K, V> {
    ...
    */
    public final V A0A(int r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.PF.A0A(int):java.lang.Object");
    }
    ...
    public final String toString() {
        ...
        for (int i = 0; i < this.A00; i++) {
            if (i > 0) {
                sb.append(A03(10, 2, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION));
            }
            K kA09 = A09(i);
            String strA03 = A03(0, 10, FacebookMediationAdapter.ERROR_INVALID_SERVER_PARAMETERS);
            if (kA09 != this) {
                sb.append(kA09);
            } else {
                sb.append(strA03);
