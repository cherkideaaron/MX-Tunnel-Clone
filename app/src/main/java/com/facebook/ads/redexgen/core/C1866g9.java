...
public final class C1866g9 implements Map<String, String> {
    ...
    public C1866g9(Map<String, String> map) {
        this.A00 = map;
    }
    ...
    public final C1866g9 A04(String str, String str2) {
        this.A00.put(str, str2);
        return this;
    }

    public final C1866g9 A05(Map<? extends String, ? extends String> arg) {
        putAll(arg);
        return this;
    }
    ...
    public final byte[] A08() throws UnsupportedEncodingException {
        byte[] bytes = null;
        try {
            bytes = A06().getBytes(A00(2, 5, 121));
            return bytes;
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
            return bytes;
