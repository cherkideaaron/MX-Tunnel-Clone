...
public class AN extends BS<String, List<String>> {
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC2333oD
    ...
    public final Set<Map.Entry<String, List<String>>> entrySet() {
        return AbstractC2484qj.A07(super.entrySet(), new InterfaceC2132kj() { // from class: com.facebook.ads.redexgen.X.pC
    ...
    public final Set<String> keySet() {
        return AbstractC2484qj.A07(super.keySet(), new InterfaceC2132kj() { // from class: com.facebook.ads.redexgen.X.pD
            @Override // com.facebook.ads.redexgen.core.InterfaceC2132kj
            public final boolean A4C(Object obj) {
