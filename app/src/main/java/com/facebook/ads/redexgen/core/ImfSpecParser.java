...
public final class ImfSpecParser {
    ...
    public static final List<ImfDataTrack> A01(String str) throws JSONException {
        C2475qY.A09(str, A00(29, 13, FacebookMediationAdapter.ERROR_INVALID_SERVER_PARAMETERS));
        ArrayList arrayList = new ArrayList();
        JSONArray jSONArray = new JSONObject(str).getJSONObject(A00(169, 17, 123)).getJSONArray(A00(0, 1, FacebookMediationAdapter.ERROR_REQUIRES_UNIFIED_NATIVE_ADS));
        ...
        for (int i = 0; i < length; i++) {
            ...
            C2475qY.A06(string2);
            C2475qY.A06(string3);
            C2043j7 c2043j7 = new C2043j7(string2, string3);
            ...
            for (int i2 = 0; i2 < length2; i2++) {
                ...
                long j = jSONObject2.getLong(strA002);
                long j2 = dataTrack.getJSONObject(strA00).getJSONObject(A00(22, 7, 94)).getLong(strA002);
                JSONObject jSONObject3 = new JSONObject(dataTrack.getString(A00(FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH, 15, 77)));
                C2475qY.A06(string);
                arrayList.add(new ImfDataTrack(string, j, j2, c2043j7, new C2042j6(jSONObject3.getDouble(A00(69, 9, 118)), jSONObject3.getDouble(A00(78, 9, 61)), jSONObject3.getDouble(A00(56, 13, 67)), jSONObject3.getDouble(A00(42, 14, 35)), jSONObject3.getDouble(A00(87, 15, 35)))));
            }
        }
        return arrayList;
    }
