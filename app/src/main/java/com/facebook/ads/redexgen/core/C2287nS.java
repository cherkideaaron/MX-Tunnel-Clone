...
public class C2287nS implements EP {
    ...
    public final InterfaceC2200lq A5K(C2461qI c2461qI) {
        char c;
        String str = c2461qI.A0W;
        if (str != null) {
            switch (str.hashCode()) {
                case 1201784583:
                    String mimeType = A00(249, 21, FacebookMediationAdapter.ERROR_NULL_CONTEXT);
                                                ...
                                                if (!mimeType11.equals(str)) {
                                                    ...
                                                    if (!mimeType12.equals(str)) {
                                                        ...
                                                        if (!mimeType13.equals(str)) {
                                                            String mimeType14 = A00(249, 21, FacebookMediationAdapter.ERROR_NULL_CONTEXT);
