...
public enum EnumC1411Xc {
    ...
    EnumC1411Xc(int i, NativeAdBase.NativeComponentTag nativeComponentTag) {
        this.A00 = i;
        this.A01 = nativeComponentTag;
    }

    @Nullable
    public static EnumC1411Xc A00(NativeAdBase.NativeComponentTag nativeComponentTag) {
        for (EnumC1411Xc enumC1411Xc : values()) {
            if (enumC1411Xc.A01 == nativeComponentTag) {
                return enumC1411Xc;
            }
        }
        return null;
    ...
    public static void A03(@Nullable View view, NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC1411Xc internalTag = A00(nativeComponentTag);
        if (view != null && internalTag != null) {
            view.setTag(A02, nativeComponentTag);
        }
    }

    public static void A04(@Nullable View view, @Nullable EnumC1411Xc enumC1411Xc) {
        if (view != null && enumC1411Xc != null) {
            view.setTag(A02, enumC1411Xc);
        }
    }
