...
public final class zzpp extends zzjf {
    ...
    public static boolean zzQ(Context context, boolean z) {
        ...
        return zzR(context, Build.VERSION.SDK_INT >= 24 ? "com.google.android.gms.measurement.AppMeasurementJobService" : "com.google.android.gms.measurement.AppMeasurementService");
    }
    ...
    */
                ...
                if (zzh(str3)) {
                    ...
                    if (i3 > i) {
                        if (!zzicVar.zzc().zzp(null, zzfy.zzbe) || !z2) {
                            zzicVar.zzaV().zzd().zzc(AbstractC3219pQ.e(new StringBuilder(String.valueOf(i).length() + 37), "Event can't contain more than ", i, " params"), zzicVar.zzl().zza(str2), zzicVar.zzl().zze(bundle));
                        }
                        zzax(bundle2, 5);
                        bundle2.remove(str3);
                        z2 = true;
        ...
        while (it.hasNext()) {
            ...
            if (zzh(str) && (i2 = i2 + 1) > i) {
                ...
                if (!zzicVar.zzc().zzp(null, zzfy.zzbe) || !z) {
                    zzicVar.zzaV().zzd().zzc(AbstractC3219pQ.e(new StringBuilder(String.valueOf(i).length() + 37), "Event can't contain more than ", i, " params"), zzicVar.zzl().zza(zzgvVar.zza), zzicVar.zzl().zze(bundle));
                    zzax(bundle, 5);
                }
                bundle.remove(str);
                z = true;
        ...
        for (Parcelable parcelable : parcelableArr) {
            ...
            while (it.hasNext()) {
                ...
                if (zzh(str) && !zzaA(str, zzjn.zzd) && (i2 = i2 + 1) > i) {
                    zzic zzicVar = this.zzu;
                    if (!zzicVar.zzc().zzp(null, zzfy.zzbe) || !z) {
                        zzicVar.zzaV().zzd().zzc(AbstractC3219pQ.e(new StringBuilder(String.valueOf(i).length() + 60), "Param can't contain more than ", i, " item-scoped custom parameters"), zzicVar.zzl().zzb(str), zzicVar.zzl().zze(bundle));
                    }
                    zzax(bundle, 28);
                    bundle.remove(str);
                    z = true;
    ...
    public final AbstractC3131nu zzT() {
        if (this.zzg == null) {
            this.zzg = AbstractC3131nu.a(this.zzu.zzaY());
        }
        return this.zzg;
    }
    ...
    public final boolean zzW() {
        ...
        Integer num;
        if (this.zzh == null) {
            AbstractC3131nu abstractC3131nuZzT = zzT();
            boolean z = false;
            if (abstractC3131nuZzT == null) {
                return false;
            }
            try {
                num = (Integer) abstractC3131nuZzT.b().get(10000L, TimeUnit.MILLISECONDS);
                if (num != null) {
                    try {
                        if (num.intValue() == 1) {
                            z = true;
    ...
    public final void zzba() {
        ...
        if (jNextLong == 0) {
            ...
            if (jNextLong == 0) {
                AbstractC3264qG.y(this.zzu, "Utils falling back to Random for random id");
            }
        }
            ...
            if (iZzq != 0) {
                ...
                if (iZzD != 0 && !"_ev".equals(str4)) {
                    ...
                    if (zzag(231100000, true)) {
                        ...
                        if (i5 > i) {
                            if (!zzicVar.zzc().zzp(null, zzfy.zzbe) || !z2) {
                                zzicVar.zzaV().zzd().zzc(AbstractC3219pQ.e(new StringBuilder(String.valueOf(i).length() + 55), "Item can't contain more than ", i, " item-scoped custom params"), zzicVar.zzl().zza(str2), zzicVar.zzl().zze(bundle));
                            }
                            zzax(bundle, 28);
                            bundle.remove(str4);
                            i4 = i5;
