    ...
    public static final class Builder {
        ...
        public GoogleApiClient build() {
            ...
            for (Api api2 : map.keySet()) {
                ...
                z3.put(api2, Boolean.valueOf(z2));
                ...
                z32.put(api2.zac(), clientBuildClient);
                ...
                if (clientBuildClient.providesSignIn()) {
                    if (api != null) {
                        ...
                        throw new IllegalStateException(Vs.o(new StringBuilder(String.valueOf(strZad).length() + 21 + String.valueOf(strZad2).length()), strZad, " cannot be used with ", strZad2));
                    }
                    api = api2;
                }
            }
            if (api != null) {
                if (z) {
                    ...
                    throw new IllegalStateException(Vs.o(new StringBuilder(String.valueOf(strZad3).length() + 82), "With using ", strZad3, ", GamesOptions can only be specified within GoogleSignInOptions.Builder"));
                }
            ...
            zaaz zaazVar = new zaaz(this.zai, new ReentrantLock(), this.zan, clientSettingsZaa, this.zao, this.zap, z3, this.zaq, this.zar, z32, this.zal, zaaz.zaf(z32.values(), true), arrayList);
        ...
        public Builder enableAutoManage(q qVar, int i, OnConnectionFailedListener onConnectionFailedListener) {
