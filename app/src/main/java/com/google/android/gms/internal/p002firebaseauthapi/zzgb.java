...
public final class zzgb extends zzcw {
    ...
    public static zzgb zza(zzge.zza zzaVar, zzaal zzaalVar, Integer num) throws GeneralSecurityException {
        ...
        if (zzaVar != zzaVar2 && num == null) {
            throw new GeneralSecurityException(AbstractC3264qG.x("For given Variant ", String.valueOf(zzaVar), " the value of idRequirement must be non-null"));
        }
        if (zzaVar == zzaVar2 && num != null) {
            throw new GeneralSecurityException("For given Variant NO_PREFIX the value of idRequirement must be null");
        }
        if (zzaalVar.zza() != 32) {
            throw new GeneralSecurityException(Vs.k(zzaalVar.zza(), "XChaCha20Poly1305 key must be constructed with key of length 32 bytes, not "));
        }
