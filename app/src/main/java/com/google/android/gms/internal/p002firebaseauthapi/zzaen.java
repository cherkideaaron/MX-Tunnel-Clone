...
public final class zzaen {
    ...
    static {
        ...
        sparseArray.put(17214, new Pair<>("ERROR_INVALID_HOSTING_LINK_DOMAIN", "The provided hosting link domain is not configured in Firebase Hosting or is not owned by the current project. This cannot be a default hosting domain (web.app or firebaseapp.com). "));
    ...
    public static C0057Ck zza(FirebaseAuth firebaseAuth, zzaas zzaasVar, AbstractC2739gl abstractC2739gl) {
        List list;
        SafeParcelable safeParcelable;
        zzu.zza(firebaseAuth);
        zzu.zza(zzaasVar);
        Pair<String, String> pair = zza.get(17078);
        String str = (String) pair.first;
        String str2 = (String) pair.second;
        List<Bv> listZzc = zzaasVar.zzc();
        ...
        List<Bv> listZzc2 = zzaasVar.zzc();
        ArrayList arrayList2 = new ArrayList();
        for (Bv bv2 : listZzc2) {
            if (bv2 instanceof HJ) {
                arrayList2.add((HJ) bv2);
            }
        }
        List<Bv> listZzc3 = zzaasVar.zzc();
        String strZzb = zzaasVar.zzb();
        Preconditions.checkNotNull(listZzc3);
        Preconditions.checkNotEmpty(strZzb);
        GP gp = new GP();
        gp.c = new ArrayList();
        gp.d = new ArrayList();
        for (Bv bv3 : listZzc3) {
            if (bv3 instanceof Ty) {
                list = gp.c;
                safeParcelable = (Ty) bv3;
            } else {
                if (!(bv3 instanceof HJ)) {
                    throw new IllegalArgumentException("MultiFactorInfo must be either PhoneMultiFactorInfo or TotpMultiFactorInfo. The factorId of this MultiFactorInfo: ".concat(bv3.b()));
                }
                list = gp.d;
                safeParcelable = (HJ) bv3;
            }
        ...
        c3663xk.a();
        new FP(arrayList, gp, c3663xk.b, zzaasVar.zza(), (BP) abstractC2739gl, arrayList2);
        return new C0057Ck(str, str2);
    }
    ...
    public static boolean zzc(Exception exc) {
        if (exc instanceof C0040Bk) {
            return ((C0040Bk) exc).a.endsWith("INVALID_RECAPTCHA_TOKEN");
        }
        return false;
    }

    public static boolean zzd(Exception exc) {
        if (exc instanceof C0040Bk) {
            return ((C0040Bk) exc).a.endsWith("MISSING_RECAPTCHA_TOKEN");
        }
        return false;
    }
    ...
    public static boolean zzb(Exception exc) {
        if (exc instanceof C0040Bk) {
            return ((C0040Bk) exc).a.endsWith("APP_NOT_AUTHORIZED");
        }
        return false;
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:51:0x00db A[FALL_THROUGH] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static defpackage.C0142Hk zza(com.google.android.gms.common.api.Status r3) {
        /*
            Method dump skipped, instructions count: 556
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzaen.zza(com.google.android.gms.common.api.Status):Hk");
    }

    public static C0142Hk zza(Status status, AbstractC2814i4 abstractC2814i4, String str, String str2) {
        int statusCode = status.getStatusCode();
        if (statusCode != 17012 && statusCode != 17007 && statusCode != 17025) {
            return zza(status);
        }
        return new C0023Ak(zza(statusCode), zza(zzb(statusCode), status));
    }
    ...
    private static String zza(String str, Status status) {
        return TextUtils.isEmpty(status.getStatusMessage()) ? str : String.format(AbstractC3264qG.g(str, " [ %s ]"), status.getStatusMessage());
    }

    public static boolean zza(Exception exc) {
        if (exc instanceof C0040Bk) {
            return ((C0040Bk) exc).a.endsWith("ALTERNATE_CLIENT_IDENTIFIER_REQUIRED");
        }
        return false;
    }
}
