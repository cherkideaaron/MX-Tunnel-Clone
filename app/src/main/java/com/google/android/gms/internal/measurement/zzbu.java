...
final class zzbu extends zzca {
    ...
    public final String toString() {
        ...
        StringBuilder sb = new StringBuilder(str2.length() + Vs.f(String.valueOf(str3).length() + 73, 91, str) + 1);
        AbstractC3264qG.v(sb, "FileComplianceOptions{fileOwner=", str3, ", hasDifferentDmaOwner=false, fileChecks=", str);
        return Vs.o(sb, ", dataForwardingNotAllowedResolver=null, multipleProductIdGroupsResolver=null, filePurpose=", str2, "}");
    }
