...
public class zzl {
    ...
    private static Object zzi(Task task, String str) throws IOException, ApiException {
        try {
            ...
            String strX = AbstractC3264qG.x("Interrupted while waiting for the task of ", str, " to finish.");
            zzd.w(strX, new Object[0]);
            throw new IOException(strX, e);
        } catch (CancellationException e2) {
            String strX2 = AbstractC3264qG.x("Canceled while waiting for the task of ", str, " to finish.");
            zzd.w(strX2, new Object[0]);
            throw new IOException(strX2, e2);
        } catch (ExecutionException e3) {
            Throwable cause = e3.getCause();
            if (cause instanceof ApiException) {
                throw ((ApiException) cause);
            }
            String strX3 = AbstractC3264qG.x("Unable to get a result for ", str, " due to ExecutionException.");
            zzd.w(strX3, new Object[0]);
            throw new IOException(strX3, e3);
        }
    }
