...
public final class zzafb extends zzaft implements zzagn {
    ...
    private final C3663xk zze;
    private String zzf;
    private zzafe zzg;

    public zzafb(C3663xk c3663xk, zzafc zzafcVar) {
        this(c3663xk, zzafcVar, null, null, null, null);
    }
    ...
    private zzafb(C3663xk c3663xk, zzafc zzafcVar, zzafy zzafyVar, zzaev zzaevVar, zzaey zzaeyVar, zzaew zzaewVar) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        this.zze = c3663xk;
        c3663xk.a();
    ...
    public final void zza(zzaht zzahtVar, zzafv<zzahs> zzafvVar) {
        ...
        Preconditions.checkNotNull(zzafvVar);
        zzaey zzaeyVar = this.zzb;
        String strH = zzaeyVar.zza("/recaptchaConfig", this.zzf) + "&clientType=" + zzahtVar.zzb() + "&version=" + zzahtVar.zzc();
        if (!zzac.zzc(zzahtVar.zzd())) {
            strH = AbstractC3264qG.h(strH, "&tenantId=", zzahtVar.zzd());
        }
        zzafu.zza(strH, zzafvVar, zzahs.class, zzaeyVar.zza);
    }
