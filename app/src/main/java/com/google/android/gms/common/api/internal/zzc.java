...
final class zzc {
    private final Map zza = Collections.synchronizedMap(new Z3());
    private int zzb = 0;
    private Bundle zzc;
    ...
    public final void zzb(String str, LifecycleCallback lifecycleCallback) {
        ...
        if (map.containsKey(str)) {
            throw new IllegalArgumentException(Vs.o(new StringBuilder(String.valueOf(str).length() + 59), "LifecycleCallback with tag ", str, " already added to this fragment."));
        }
