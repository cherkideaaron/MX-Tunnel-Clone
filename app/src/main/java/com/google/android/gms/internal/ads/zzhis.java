...
public final class zzhis {
    ...
    public static ECPoint zzd(BigInteger bigInteger, ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        ...
        zzhir zzhirVarZze = zze(ECPoint.POINT_INFINITY, bigIntegerZzc);
        zzhir zzhirVarZze2 = zze(generator, bigIntegerZzc);
        for (int iBitLength = bigInteger.bitLength(); iBitLength >= 0; iBitLength--) {
            if (bigInteger.testBit(iBitLength)) {
                zzhirVarZze = zzg(zzhirVarZze, zzhirVarZze2, a, bigIntegerZzc);
                zzhirVarZze2 = zzf(zzhirVarZze2, a, bigIntegerZzc);
            } else {
                zzhirVarZze2 = zzg(zzhirVarZze, zzhirVarZze2, a, bigIntegerZzc);
                zzhirVarZze = zzf(zzhirVarZze, a, bigIntegerZzc);
            }
        }
        if (zzhirVarZze.zza()) {
            eCPoint = ECPoint.POINT_INFINITY;
        } else {
            BigInteger bigIntegerModInverse = zzhirVarZze.zzc.modInverse(bigIntegerZzc);
            BigInteger bigIntegerMod = bigIntegerModInverse.multiply(bigIntegerModInverse).mod(bigIntegerZzc);
            eCPoint = new ECPoint(zzhirVarZze.zza.multiply(bigIntegerMod).mod(bigIntegerZzc), zzhirVarZze.zzb.multiply(bigIntegerMod).mod(bigIntegerZzc).multiply(bigIntegerModInverse).mod(bigIntegerZzc));
        }
        zza(eCPoint, curve);
        return eCPoint;
    }

    public static zzhir zze(ECPoint eCPoint, BigInteger bigInteger) {
        if (eCPoint.equals(ECPoint.POINT_INFINITY)) {
            return zzhir.zzd;
        }
        BigInteger bigIntegerMod = new BigInteger(1, zzhle.zza((bigInteger.bitLength() + 8) / 8)).mod(bigInteger);
        BigInteger bigIntegerMod2 = bigIntegerMod.multiply(bigIntegerMod).mod(bigInteger);
        return new zzhir(eCPoint.getAffineX().multiply(bigIntegerMod2).mod(bigInteger), eCPoint.getAffineY().multiply(bigIntegerMod2.multiply(bigIntegerMod).mod(bigInteger)).mod(bigInteger), bigIntegerMod);
    }

    public static zzhir zzf(zzhir zzhirVar, BigInteger bigInteger, BigInteger bigInteger2) {
        BigInteger bigInteger3 = zzhirVar.zzb;
        if (bigInteger3.equals(BigInteger.ZERO)) {
            return zzhir.zzd;
        }
        BigInteger bigInteger4 = zzhirVar.zza;
        ...
        BigInteger bigInteger5 = zzhirVar.zzc;
        ...
        return new zzhir(bigIntegerMod5, bigIntegerMod6, bigIntegerAdd3.multiply(bigIntegerAdd3).mod(bigInteger2).subtract(bigIntegerMod2).subtract(bigIntegerMod4).mod(bigInteger2));
    }

    public static zzhir zzg(zzhir zzhirVar, zzhir zzhirVar2, BigInteger bigInteger, BigInteger bigInteger2) {
        if (zzhirVar.zza()) {
            return zzhirVar2;
        }
        if (zzhirVar2.zza()) {
        ...
        BigInteger bigInteger3 = zzhirVar.zzc;
        BigInteger bigIntegerMod = bigInteger3.multiply(bigInteger3).mod(bigInteger2);
        BigInteger bigInteger4 = zzhirVar2.zzc;
        BigInteger bigIntegerMod2 = bigInteger4.multiply(bigInteger4).mod(bigInteger2);
        BigInteger bigIntegerMod3 = zzhirVar.zza.multiply(bigIntegerMod2).mod(bigInteger2);
        BigInteger bigIntegerMod4 = zzhirVar2.zza.multiply(bigIntegerMod).mod(bigInteger2);
        BigInteger bigIntegerMod5 = zzhirVar.zzb.multiply(bigInteger4).mod(bigInteger2).multiply(bigIntegerMod2).mod(bigInteger2);
        BigInteger bigIntegerMod6 = zzhirVar2.zzb.multiply(bigInteger3).mod(bigInteger2).multiply(bigIntegerMod).mod(bigInteger2);
        if (bigIntegerMod3.equals(bigIntegerMod4)) {
            return !bigIntegerMod5.equals(bigIntegerMod6) ? zzhir.zzd : zzf(zzhirVar, bigInteger, bigInteger2);
        }
        ...
        return new zzhir(bigIntegerMod12, bigIntegerMod13, bigIntegerAdd.multiply(bigIntegerAdd).mod(bigInteger2).subtract(bigIntegerMod).subtract(bigIntegerMod2).multiply(bigIntegerMod7).mod(bigInteger2));
    }
