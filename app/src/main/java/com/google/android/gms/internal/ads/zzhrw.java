...
public final class zzhrw extends zzibr implements zzidd {
    private static final zzhrw zzb;
    ...
    static {
        ...
        zzb = zzhrwVar;
        zzibr.zzbu(zzhrw.class, zzhrwVar);
    }

    private zzhrw() {
    }

    public static zzhrv zzb() {
        return (zzhrv) zzb.zzbn();
    }

    public static zzhrw zzc() {
        return zzb;
    }
