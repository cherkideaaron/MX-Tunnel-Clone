    ...
    public static ECPoint zza(BigInteger bigInteger, ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        ...
        for (int iBitLength = bigInteger.bitLength(); iBitLength >= 0; iBitLength--) {
            if (bigInteger.testBit(iBitLength)) {
                zzniVarZza = zza(zzniVarZza, zzniVarZza2, a, bigIntegerZza);
                zzniVarZza2 = zza(zzniVarZza2, a, bigIntegerZza);
            } else {
                zzniVarZza2 = zza(zzniVarZza, zzniVarZza2, a, bigIntegerZza);
                zzniVarZza = zza(zzniVarZza, a, bigIntegerZza);
            }
        }
        if (zzniVarZza.zza()) {
