...
public final class zzbyz extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(id = UserVerificationMethods.USER_VERIFY_EYEPRINT)
    public final String zzae;

    @SafeParcelable.Field(id = RegisterRequest.U2F_V1_CHALLENGE_BYTE_LENGTH)
