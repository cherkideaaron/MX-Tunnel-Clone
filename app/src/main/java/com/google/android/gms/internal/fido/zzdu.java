...
public final class zzdu implements Closeable {
    ...
    private final long zzh() throws IOException {
        ...
        if (this.zzb.zza() != 27) {
            throw new IOException(AbstractC3264qG.e(this.zzb.zza(), this.zzb.zzc(), "invalid additional information ", " for major type "));
        }
        zzk(this.zzc, 8);
        byte[] bArr3 = this.zzc;
        long j3 = bArr3[0];
    ...
    private final void zzi() {
        zzd();
        if (this.zzb.zza() == 31) {
            throw new IllegalStateException(Vs.k(this.zzb.zza(), "expected definite length but found "));
        }
    }
    ...
    private final void zzj(byte b) {
        zzd();
        if (this.zzb.zzb() != b) {
            throw new IllegalStateException(AbstractC3264qG.e((b >> 5) & 7, this.zzb.zzc(), "expected major type ", " but found "));
        }
    }
    ...
    public final long zzb() {
        ...
        if (this.zzb.zzb() == 0) {
            ...
            if (this.zzb.zzb() != 32) {
                throw new IllegalStateException(Vs.k(this.zzb.zzc(), "expected major type 0 or 1 but found "));
            }
            z = false;
        }
        long jZzh = zzh();
                ...
                if (bZzb != -32) {
                    if (bZzb != 0 && bZzb != 32) {
                        if (bZzb == 64) {
                            ...
                            if (bZzb != 96) {
                                throw new IllegalStateException(Vs.k(this.zzb.zzc(), "invalid major type: "));
                            }
                            this.zzd.zze(-2L);
                        }
                    }
