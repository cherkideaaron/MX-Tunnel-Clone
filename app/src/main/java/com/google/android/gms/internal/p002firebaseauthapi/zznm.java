...
public final class zznm {
    ...
    public static void zzb(long[] jArr, long[] jArr2) {
        ...
        long j9 = jArr2[8];
        long j10 = jArr2[9];
        zze(new long[]{j * j, j * 2 * j2, ((j * j3) + (j2 * j2)) * 2, ((j * j4) + (j2 * j3)) * 2, (j * 2 * j5) + (j2 * 4 * j4) + (j3 * j3), ((j * j6) + (j2 * j5) + (j3 * j4)) * 2, ((j2 * 2 * j6) + (j * j7) + (j3 * j5) + (j4 * j4)) * 2, ((j * j8) + (j2 * j7) + (j3 * j6) + (j4 * j5)) * 2, (((((j4 * j6) + (j2 * j8)) * 2) + (j * j9) + (j3 * j7)) * 2) + (j5 * j5), ((j * j10) + (j2 * j9) + (j3 * j8) + (j4 * j7) + (j5 * j6)) * 2, ((((j2 * j10) + (j4 * j8)) * 2) + (j3 * j9) + (j5 * j7) + (j6 * j6)) * 2, ((j3 * j10) + (j4 * j9) + (j5 * j8) + (j6 * j7)) * 2, (((((j4 * j10) + (j6 * j8)) * 2) + (j5 * j9)) * 2) + (j7 * j7), ((j5 * j10) + (j6 * j9) + (j7 * j8)) * 2, ((j6 * 2 * j10) + (j7 * j9) + (j8 * j8)) * 2, ((j7 * j10) + (j8 * j9)) * 2, (j8 * 4 * j10) + (j9 * j9), j9 * 2 * j10, 2 * j10 * j10}, jArr);
    }
    ...
    public static byte[] zzc(long[] jArr) {
        ...
        long j5 = (((int) (r9 >> 25)) * 19) + jArrCopyOf[0];
        jArrCopyOf[0] = j5;
        ...
        for (int i15 = 2; i15 < 10; i15 += 2) {
            ...
            int i16 = i15 + 1;
            jArrCopyOf[i16] = jArrCopyOf[i16] - j6;
        }
