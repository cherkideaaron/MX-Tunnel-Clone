...
import defpackage.InterfaceC3179on;
...
public final class zzkg {
    ...
    private zzkg(String str, Uri uri, String str2, String str3, boolean z, boolean z2, boolean z3, boolean z4, InterfaceC3179on interfaceC3179on) {
        this.zza = uri;
        this.zzb = "";
        this.zzc = "";
        this.zzd = z;
