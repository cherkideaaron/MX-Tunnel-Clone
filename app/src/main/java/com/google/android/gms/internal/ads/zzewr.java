...
public final class zzewr implements zzikg {
    ...
    public final /* bridge */ /* synthetic */ Object zzb() {
        zzeur zzeurVarZzb = ((zzeut) this.zza).zzb();
        zzevl zzevlVar = (zzevl) this.zzb.zzb();
        List list = (List) this.zzc.zzb();
        ScheduledExecutorService scheduledExecutorService = (ScheduledExecutorService) this.zzd.zzb();
        if (list.contains("54")) {
            return new zzezj(zzevlVar, ((Integer) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zznN)).intValue(), scheduledExecutorService);
        }
        return new zzezj(zzeurVarZzb, ((Integer) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zznN)).intValue(), scheduledExecutorService);
    }
}
