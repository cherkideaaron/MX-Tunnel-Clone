...
public final class zzecp {
    ...
    private final String zzc() throws SecurityException {
        ...
        if (versionInfoParcel.isClientJar) {
            ...
            try {
                name = (String) new JSONObject(zzd((String) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zzpL))).get(Integer.toString(versionInfoParcel.clientJarVersion));
        ...
        try {
            strZzd = zzd((String) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zzpM));
