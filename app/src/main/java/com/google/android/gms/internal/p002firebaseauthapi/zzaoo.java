...
public final class zzaoo {
    ...
    public static zzans zza(String str) throws ParseException {
        ...
        if (iIndexOf == -1) {
            throw new ParseException(AbstractC3264qG.x("Failed to parse timestamp: invalid timestamp \"", str, "\""), 0);
        }
        ...
        if (str.charAt(iIndexOf2) != 'Z') {
            ...
            throw new ParseException(AbstractC3264qG.x("Failed to parse timestamp: invalid trailing data \"", str.substring(iIndexOf2), "\""), 0);
        }
        try {
            if (!zza(time)) {
            ...
            ParseException parseException = new ParseException(AbstractC3264qG.x("Failed to parse timestamp ", str, " Timestamp is out of range."), 0);
            parseException.initCause(e);
            throw parseException;
        }
    }
