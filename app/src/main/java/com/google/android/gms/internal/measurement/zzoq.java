...
final class zzoq {
    ...
    public static /* synthetic */ void zzb(byte b, byte b2, char[] cArr, int i) throws zzmr {
        if (b < -62 || zze(b2)) {
    ...
    */
    ...
    public static /* synthetic */ void zzd(byte b, byte b2, byte b3, byte b4, char[] cArr, int i) throws zzmr {
        if (!zze(b2)) {
