...
final class zzafh implements zzaem {
    ...
    private final void zza(Status status, AbstractC2814i4 abstractC2814i4, String str, String str2) {
        zzaff.zza(this.zza, status);
        zzaff zzaffVar = this.zza;
        zzaffVar.zzn = abstractC2814i4;
        zzaffVar.zzo = str;
        zzaffVar.zzp = str2;
        LP lp = zzaffVar.zzf;
        if (lp != null) {
    ...
    @Override // com.google.android.gms.internal.p002firebaseauthapi.zzaem
    public final void zza(Status status, Py py) {
        int i = this.zza.zza;
        Preconditions.checkState(i == 2, "Unexpected response type " + i);
        zza(status, py, null, null);
    }
    ...
    public final void zza(zzaas zzaasVar) {
        ...
        zzaffVar.zza(JP.b("REQUIRES_SECOND_FACTOR_AUTH"));
    }
