...
public final class zzear extends zzfyq {
    ...
    public final void zzd(SensorEvent sensorEvent) {
        if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zzkz)).booleanValue()) {
            ...
            if (this.zze + ((Integer) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zzkB)).intValue() < jCurrentTimeMillis) {
                this.zzf = 0;
            ...
            if (fFloatValue > ((Float) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbgvVar)).floatValue() + f) {
                this.zzc = this.zzd.floatValue();
                this.zzh = true;
            ...
            if (this.zzg && this.zzh) {
                ...
                if (zzeaqVar != null) {
                    if (i == ((Integer) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zzkC)).intValue()) {
