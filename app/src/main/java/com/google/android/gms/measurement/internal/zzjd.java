...
public final class zzjd extends zzga {
        ...
        for (zzpj zzpjVar : listZzC) {
            if (zzpgVar.zzO(str, zzpjVar.zze())) {
                ...
                if (iZzi > 0) {
                    ...
                    zzgsVarZzk = zzpgVar.zzaV().zzk();
                    lValueOf = Long.valueOf(zzpjVar.zzc());
                    objZze = Long.valueOf(zzpjVar.zzh());
            ...
            zzgsVarZzk.zzd(str2, str, lValueOf, objZze);
        }
    ...
    public final /* synthetic */ void zzK(Bundle bundle, String str, zzr zzrVar) throws SQLException {
        zzpg zzpgVar = this.zza;
    ...
    public final void zzb(zzbg zzbgVar, zzr zzrVar) {
        ...
        com.google.android.gms.internal.measurement.zzc zzcVar = TextUtils.isEmpty(str3) ? null : (com.google.android.gms.internal.measurement.zzc) zzhtVarZzh.zzd.get(str3);
        if (zzcVar != null) {
            try {
                Map mapZzz = zzpgVar.zzp().zzz(zzbgVar.zzb.zzf(), true);
                String str4 = zzbgVar.zza;
                String strZza = zzjm.zza(str4);
                if (strZza != null) {
                    str4 = strZza;
                }
                if (zzcVar.zzb(new com.google.android.gms.internal.measurement.zzaa(str4, zzbgVar.zzd, mapZzz))) {
                    if (zzcVar.zzc()) {
                        zzpg zzpgVar2 = this.zza;
                        zzpgVar2.zzaV().zzk().zzb("EES edited event", zzbgVar.zza);
                        zzbgVar = zzpgVar2.zzp().zzA(zzcVar.zze().zzc());
                    }
                    zzM(zzbgVar, zzrVar);
                    if (zzcVar.zzd()) {
