...
public final class zzam {
    ...
    public final /* synthetic */ zzguf zzW() {
        return this.zzz;
    }
    ...
    public final zzam zzb(CharSequence charSequence) {
        this.zzb = charSequence;
        return this;
    }

    public final zzam zzc(CharSequence charSequence) {
        this.zzc = charSequence;
        return this;
    }

    public final zzam zzd(CharSequence charSequence) {
        this.zzd = charSequence;
        return this;
    }

    public final zzam zze(CharSequence charSequence) {
        this.zze = charSequence;
        return this;
    }

    public final zzam zzf(byte[] bArr, int i) {
    ...
    public final zzam zzg(Integer num) {
        this.zzh = num;
        return this;
    }

    public final zzam zzh(Integer num) {
        this.zzi = num;
        return this;
    }

    public final zzam zzi(Integer num) {
        this.zzl = num;
        return this;
    }

    public final zzam zzj(Integer num) {
        this.zzm = num;
        return this;
    }

    public final zzam zzk(Integer num) {
        this.zzn = num;
        return this;
    }

    public final zzam zzl(Integer num) {
        this.zzo = num;
        return this;
    }

    public final zzam zzm(Integer num) {
        this.zzp = num;
        return this;
    }

    public final zzam zzn(Integer num) {
        this.zzq = num;
        return this;
    }

    public final zzam zzo(CharSequence charSequence) {
        this.zzr = charSequence;
        return this;
    }

    public final zzam zzp(CharSequence charSequence) {
        this.zzs = charSequence;
        return this;
    }

    public final zzam zzq(CharSequence charSequence) {
        this.zzt = charSequence;
        return this;
    }

    public final zzam zzr(Integer num) {
        this.zzu = num;
        return this;
    }

    public final zzam zzs(Integer num) {
        this.zzv = num;
        return this;
    }

    public final zzam zzt(CharSequence charSequence) {
        this.zzw = charSequence;
        return this;
    }

    public final zzam zzu(CharSequence charSequence) {
        this.zzx = charSequence;
        return this;
    }

    public final zzam zzv(zzan zzanVar) {
        if (zzanVar != null) {
            ...
            zzguf zzgufVar = zzanVar.zzB;
            if (!zzgufVar.isEmpty()) {
                this.zzz = zzguf.zzq(zzgufVar);
            }
        }
        return this;
    }
