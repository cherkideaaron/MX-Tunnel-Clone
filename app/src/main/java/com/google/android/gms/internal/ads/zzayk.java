...
final class zzayk implements zzayh {
    ...
    public final void zza(byte[] bArr, byte[] bArr2) {
        ...
        int i = ~zzayuVar.zzB;
        zzayuVar.zzB = i;
        int i2 = zzayuVar.zzbM ^ zzayuVar.zzbK;
        int i3 = zzayuVar.zzy;
        int i4 = ((((i2 | i3) ^ zzayuVar.zzO) ^ zzayuVar.zzcl) ^ zzayuVar.zzaW) ^ zzayuVar.zzP;
        zzayuVar.zzP = i4;
        int i5 = zzayuVar.zzG;
        int i6 = zzayuVar.zzaI;
        int i7 = ~i6;
        int i8 = i5 & i7;
        int i9 = i5 ^ i8;
        zzayuVar.zzaW = i9;
        int i10 = zzayuVar.zzb;
        int i11 = zzayuVar.zzas;
        int i12 = zzayuVar.zzx;
        int i13 = (((i8 ^ i10) | i11) ^ i12) ^ zzayuVar.zzbu;
        zzayuVar.zzbu = i13;
        int i14 = i10 ^ i5;
        zzayuVar.zzcl = i14;
        int i15 = i7 & i14;
        int i16 = (i11 | i15) ^ zzayuVar.zzbH;
        zzayuVar.zzO = i16;
        int i17 = (i12 ^ ((~i15) & i11)) | i3;
        int i18 = (i6 | i14) ^ i10;
        int i19 = i11 | i18;
        int i20 = zzayuVar.zzah ^ i19;
        zzayuVar.zzb = i20;
        int i21 = zzayuVar.zzce ^ i20;
        int i22 = zzayuVar.zzcy;
        int i23 = ((i21 | i22) ^ i13) ^ zzayuVar.zzL;
        zzayuVar.zzL = i23;
        int i24 = zzayuVar.zzbh ^ (((i11 & i18) ^ i18) | i3);
        zzayuVar.zzce = i24;
        int i25 = i18 ^ (i11 & i15);
        zzayuVar.zzbK = i25;
        int i26 = i25 ^ i17;
