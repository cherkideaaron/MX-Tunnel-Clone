...
public final class zzs extends zzbz {
    ...
    static {
        Z3 z3 = new Z3();
        zzb = z3;
        z3.put("registered", FastJsonResponse.Field.forStrings("registered", 2));
        z3.put("in_progress", FastJsonResponse.Field.forStrings("in_progress", 3));
        z3.put("success", FastJsonResponse.Field.forStrings("success", 4));
        z3.put("failed", FastJsonResponse.Field.forStrings("failed", 5));
        z3.put("escrowed", FastJsonResponse.Field.forStrings("escrowed", 6));
    }
    ...
    public final Object getFieldValue(FastJsonResponse.Field field) {
        switch (field.getSafeParcelableFieldId()) {
            ...
            case 6:
                return this.zzg;
            default:
                throw new IllegalStateException(Vs.k(field.getSafeParcelableFieldId(), "Unknown SafeParcelable id="));
        }
    }
