...
final class zzav extends zzos {
    ...
    */
    ...
    private final String zzaG() {
        ...
        StringBuilder sb = new StringBuilder(AbstractC3264qG.d(str.length(), 5, str2.length(), 1));
        AbstractC3264qG.v(sb, "(", str, " OR ", str2);
        sb.append(")");
        return sb.toString();
    }

    private static final String zzaH(List list) {
        return list.isEmpty() ? "" : AbstractC3264qG.x(" AND (upload_type IN (", TextUtils.join(", ", list), "))");
    }
    ...
    */
    ...
    public final boolean zzD(String str) {
        ...
        String strZzaG = zzaG();
        return zzay(AbstractC3264qG.m(new StringBuilder((String.valueOf(strZzaH).length() + 61) + strZzaG.length()), "SELECT COUNT(1) > 0 FROM upload_queue WHERE app_id=?", strZzaH, " AND NOT ", strZzaG), new String[]{str}) != 0;
    }
    ...
    */
    ...
    public final void zzJ(List list) throws SQLException {
        ...
        if (zzag()) {
            ...
            String strO = Vs.o(new StringBuilder(String.valueOf(strJoin).length() + 2), "(", strJoin, ")");
            if (zzay(Vs.o(new StringBuilder(strO.length() + 80), "SELECT COUNT(1) FROM queue WHERE rowid IN ", strO, " AND retry_count =  2147483647 LIMIT 1"), null) > 0) {
                AbstractC3264qG.y(this.zzu, "The number of upload retries exceeds the limit. Will remain unchanged.");
            }
            try {
                SQLiteDatabase sQLiteDatabaseZze = zze();
    ...
    public final void zzK(Long l) throws SQLException {
        zzg();
        zzaw();
        Preconditions.checkNotNull(l);
        if (zzag()) {
    ...
    public final Object zzL(Cursor cursor, int i) {
        ...
        if (type == 0) {
            AbstractC3264qG.t(this.zzu, "Loaded invalid null value from database");
            return null;
        }
        if (type == 1) {
        ...
        AbstractC3264qG.t(this.zzu, "Loaded invalid blob type value, ignoring it");
        return null;
    }
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:114:0x02ae A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:118:0x002c A[SYNTHETIC] */
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:104:0x0347, code lost:
        ...
        if (zze().insertWithOnConflict("property_filters", null, r10, 5) != (-1)) goto L109;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:55:0x0193, code lost:
        ...
        if (((com.google.android.gms.internal.measurement.zzfn) r10.next()).zza() != false) goto L172;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:62:0x01dc, code lost:
        ...
        if (r11.zzc().isEmpty() == false) goto L68;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:78:0x0265, code lost:
        ...
        if (zze().insertWithOnConflict("event_filters", null, r7, 5) != (-1)) goto L176;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:88:0x02c0, code lost:
        ...
        if (r3.zzc().isEmpty() == false) goto L94;
     */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:49:0x00fe A[Catch: all -> 0x007b, SQLiteException -> 0x007d, TryCatch #6 {all -> 0x007b, blocks: (B:17:0x0067, B:20:0x006f, B:21:0x0073, B:47:0x00d1, B:49:0x00fe, B:50:0x0113, B:51:0x0117, B:52:0x0127, B:54:0x012d, B:55:0x0140, B:58:0x015a, B:69:0x0181, B:72:0x0189, B:73:0x018d, B:77:0x019f, B:79:0x01c0, B:80:0x01c9, B:82:0x01d4, B:87:0x0205, B:86:0x01f1, B:90:0x020c, B:63:0x0170, B:76:0x019a, B:92:0x021f, B:42:0x00c1, B:45:0x00c9), top: B:114:0x0024 }] */
    /* JADX WARN: Removed duplicated region for block: B:50:0x0113 A[Catch: all -> 0x007b, SQLiteException -> 0x007d, TRY_LEAVE, TryCatch #6 {all -> 0x007b, blocks: (B:17:0x0067, B:20:0x006f, B:21:0x0073, B:47:0x00d1, B:49:0x00fe, B:50:0x0113, B:51:0x0117, B:52:0x0127, B:54:0x012d, B:55:0x0140, B:58:0x015a, B:69:0x0181, B:72:0x0189, B:73:0x018d, B:77:0x019f, B:79:0x01c0, B:80:0x01c9, B:82:0x01d4, B:87:0x0205, B:86:0x01f1, B:90:0x020c, B:63:0x0170, B:76:0x019a, B:92:0x021f, B:42:0x00c1, B:45:0x00c9), top: B:114:0x0024 }] */
    ...
    public final List zzn(String str) {
        ...
        try {
            try {
                zzic zzicVar = this.zzu;
                zzicVar.zzc();
                cursorQuery = zze().query("user_attributes", new String[]{AppMeasurementSdk.ConditionalUserProperty.NAME, "origin", "set_timestamp", AppMeasurementSdk.ConditionalUserProperty.VALUE}, "app_id=?", new String[]{str}, null, null, "rowid", "1000");
                if (cursorQuery.moveToFirst()) {
                    do {
                        String string = cursorQuery.getString(0);
