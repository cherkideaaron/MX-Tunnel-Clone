...
public final class zzsj {
    ...
    public static zzrh zzb(zzqe zzqeVar) throws GeneralSecurityException {
        if (!zzqeVar.zza().zzf().equals("type.googleapis.com/google.crypto.tink.HmacKey")) {
            throw new IllegalArgumentException(AbstractC3264qG.w("Wrong type URL in call to HmacProtoSerialization.parseParameters: ", zzqeVar.zza().zzf()));
        }
        try {
            ...
            throw new GeneralSecurityException(Vs.k(zzweVarZza.zzb(), "Parsing HmacParameters failed: unknown Version "));
        } catch (zzall e) {
