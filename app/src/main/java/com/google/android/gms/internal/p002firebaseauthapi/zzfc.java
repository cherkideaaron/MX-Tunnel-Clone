...
public final class zzfc extends zzcy {
    ...
    public static class zzb {
        ...
        public final zzfc zza() throws GeneralSecurityException {
            ...
            throw new GeneralSecurityException(Vs.m("Cannot use parsing strategy ", this.zzc.toString(), " when new keys are picked according to ", String.valueOf(this.zzd), "."));
        }
    }
    ...
    public final String toString() {
        ...
        return AbstractC3264qG.m(AbstractC3264qG.p("LegacyKmsEnvelopeAead Parameters (kekUri: ", str, ", dekParsingStrategy: ", strValueOf, ", dekParametersForNewKeys: "), String.valueOf(this.zzd), ", variant: ", String.valueOf(this.zza), ")");
    }
