...
public class AppMeasurementDynamiteService extends com.google.android.gms.internal.measurement.zzcq {
    ...
    public void initialize(IObjectWrapper iObjectWrapper, com.google.android.gms.internal.measurement.zzdd zzddVar, long j) {
        ...
        if (zzicVar == null) {
            ...
            AbstractC3264qG.y(zzicVar, "Attempting to initialize multiple times");
        }
    }
    ...
    @Override // com.google.android.gms.internal.measurement.zzcr
    public void retrieveAndUploadBatches(final com.google.android.gms.internal.measurement.zzcx zzcxVar) throws MalformedURLException {
        zzb();
    ...
    public void setConditionalUserProperty(Bundle bundle, long j) {
        zzb();
        if (bundle == null) {
            AbstractC3264qG.t(this.zza, "Conditional user property must not be null");
        } else {
    ...
    @Override // com.google.android.gms.internal.measurement.zzcr
    public void setCurrentScreenByScionActivityInfo(com.google.android.gms.internal.measurement.zzdf zzdfVar, String str, String str2, long j) {
        zzb();
    ...
    public void setUserId(final String str, long j) {
        ...
        if (str != null && TextUtils.isEmpty(str)) {
            AbstractC3264qG.y(zzljVarZzj.zzu, "User ID must be non-empty or null");
        } else {
