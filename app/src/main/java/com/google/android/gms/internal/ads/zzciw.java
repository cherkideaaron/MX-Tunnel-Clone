    ...
    public final int zza(byte[] bArr, int i, int i2) throws IOException {
        ...
        try {
            ...
            if (j5 > j7) {
                long j8 = this.zzo;
                if (j6 < j8) {
                    long jMin = Math.min(j8, Math.max(((this.zzq + j7) - r3) - 1, (-1) + j7 + j4));
                    zzk(j7, jMin, 2);
                    this.zzp = jMin;
                    j6 = jMin;
                }
        ...
        if (!TextUtils.isEmpty(headerField)) {
            ...
            if (matcher.find()) {
                try {
                    ...
                    if (j5 != -1) {
                        this.zzl = j5;
                        jMax = Math.max(j3, (this.zzn + j5) - 1);
                    } else {
                    ...
                    String strO = Vs.o(new StringBuilder(String.valueOf(headerField).length() + 27), "Unexpected Content-Range [", headerField, "]");
                    int i = com.google.android.gms.ads.internal.util.zze.zza;
    ...
    public final HttpURLConnection zzk(long j, long j2, int i) throws IOException {
        ...
        try {
            ...
            try {
                ...
                throw new zzhq("Unable to connect to ".concat(strValueOf), e2, this.zzf, 2000, i);
            }
        } catch (IOException e3) {
            String strValueOf2 = String.valueOf(string);
            throw new zzhq("Unable to connect to ".concat(strValueOf2), e3, this.zzf, 2000, i);
        }
    }
}
