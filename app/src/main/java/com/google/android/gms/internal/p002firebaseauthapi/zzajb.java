...
public final class zzajb extends AbstractSafeParcelable implements zzafa {
    ...
    public zzajb(C2563dR c2563dR, String str) {
        Preconditions.checkNotNull(c2563dR);
        this.zzl = Preconditions.checkNotEmpty(c2563dR.a);
        this.zzm = Preconditions.checkNotEmpty(str);
        this.zze = Preconditions.checkNotEmpty(c2563dR.c);
        this.zzi = true;
