...
public final class zzat {
    ...
    private final void zzt(Context context) {
        ...
        builderZzP.setSingleChoiceItems((CharSequence[]) arrayList.toArray(new String[0]), i, new DialogInterface.OnClickListener() { // from class: com.google.android.gms.ads.internal.util.zzaj
    ...
    public final String toString() {
        ...
        return AbstractC3264qG.l(sb, this.zzd, "}");
    }
    ...
    public final /* synthetic */ void zzi(AtomicInteger atomicInteger, int i, int i2, int i3, DialogInterface dialogInterface, int i4) {
        ...
        if (atomicInteger.get() != i) {
            if (atomicInteger.get() == i2) {
                zzebfVar = this.zzb;
                zzebbVar = zzebb.SHAKE;
            } else if (atomicInteger.get() == i3) {
                zzebfVar = this.zzb;
                zzebbVar = zzebb.FLICK;
            } else {
                zzebfVar = this.zzb;
                zzebbVar = zzebb.NONE;
            }
            zzebfVar.zze(zzebbVar);
        }
        zzb();
    }
