...
public final class zzgg {
    ...
    private static zzdi.zza zza(zzvy zzvyVar) throws GeneralSecurityException {
        ...
        throw new GeneralSecurityException(Vs.k(zzvyVar.zza(), "Unable to parse HashType: "));
    }
    ...
    public static zzdi zzb(zzqe zzqeVar) throws GeneralSecurityException {
        if (!zzqeVar.zza().zzf().equals("type.googleapis.com/google.crypto.tink.AesCtrHmacAeadKey")) {
            throw new IllegalArgumentException(AbstractC3264qG.w("Wrong type URL in call to AesCtrHmacAeadProtoSerialization.parseParameters: ", zzqeVar.zza().zzf()));
        }
        try {
    ...
    private static zzdi.zzc zza(zzxz zzxzVar) throws GeneralSecurityException {
        ...
        throw new GeneralSecurityException(Vs.k(zzxzVar.zza(), "Unable to parse OutputPrefixType: "));
    }
