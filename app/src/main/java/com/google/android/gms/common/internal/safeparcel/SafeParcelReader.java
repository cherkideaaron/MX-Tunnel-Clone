...
public class SafeParcelReader {
    ...
    public static void ensureAtEnd(Parcel parcel, int i) {
        if (parcel.dataPosition() != i) {
            throw new ParseException(AbstractC3264qG.k(new StringBuilder(String.valueOf(i).length() + 26), "Overread allowed size end=", i), parcel);
        }
    }
    ...
    public static int validateObjectHeader(Parcel parcel) {
        ...
        throw new ParseException(Vs.n(new StringBuilder(String.valueOf(iDataPosition).length() + 32 + String.valueOf(i).length()), "Size read is invalid start=", iDataPosition, " end=", i), parcel);
    }
    ...
    private static void zza(Parcel parcel, int i, int i2) {
        ...
        Vs.x(sb, "Expected size ", i2, " got ", size);
        throw new ParseException(Vs.o(sb, " (0x", hexString, ")"), parcel);
    }
    ...
    private static void zzb(Parcel parcel, int i, int i2, int i3) {
        ...
        Vs.x(sb, "Expected size ", i3, " got ", i2);
        throw new ParseException(Vs.o(sb, " (0x", hexString, ")"), parcel);
    }
}
