...
public final class zzl {
    ...
    private final void zzn(final Map map, final int i) throws IOException {
    ...
    public final void zzd(Map map, int i) throws IOException {
        if (zzj()) {
            zzn(map, i);
            if (i < 200 || i >= 300) {
                zzo(null);
    ...
    public final void zzf(final byte[] bArr) throws IOException {
        zzq("onNetworkResponseBody", new zzk() { // from class: com.google.android.gms.ads.internal.util.client.zzh
            ...
            public final /* synthetic */ void zza(JsonWriter jsonWriter) throws IOException {
                ...
                if (length >= 10000) {
                    strEncode = zzf.zzf(strEncode);
                    str = strEncode != null ? "bodydigest" : "body";
