...
public final class zak extends zap {
    ...
    public final void zab(int i, GoogleApiClient googleApiClient, GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
        ...
        Preconditions.checkState(iIndexOfKey < 0, AbstractC3264qG.k(new StringBuilder(String.valueOf(i).length() + 43), "Already managing a GoogleApiClient with id ", i));
        zam zamVar = (zam) this.zab.get();
        boolean z = this.zaa;
        String strValueOf = String.valueOf(zamVar);
        StringBuilder sb = new StringBuilder(AbstractC3264qG.d(String.valueOf(i).length(), 32, String.valueOf(z).length(), 1) + strValueOf.length());
