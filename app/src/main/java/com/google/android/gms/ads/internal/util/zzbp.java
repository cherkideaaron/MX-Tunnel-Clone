...
public final class zzbp {
    ...
    public static JSONObject zzd(JsonReader jsonReader) {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (JsonToken.BEGIN_ARRAY.equals(jsonTokenPeek)) {
                ...
                objZze = jsonReader.nextString();
            }
            jSONObject.put(strNextName, objZze);
        }
        jsonReader.endObject();
        return jSONObject;
    }
                    ...
                    if (objOpt instanceof JSONArray) {
                        ...
                        if (jSONArray.length() != 0) {
                            ...
                            if (objOpt2 == null) {
                                ...
                                strConcat = "JSONArray with unsupported type " + objOpt2.getClass().getCanonicalName() + " for key:" + next;
                                int i4 = zze.zza;
                            }
                        }
    ...
    public static String zzm(zzfiw zzfiwVar) throws JSONException, IOException {
        if (zzfiwVar == null) {
            return null;
        }
