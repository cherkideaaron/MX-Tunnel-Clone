...
public final class zzpe implements zzpd {
    ...
    static {
        ...
        zzf = zzkgVarZzb.zzc("measurement.config.cache_time", TimeChart.DAY);
        ...
        zzA = zzkgVarZzb.zzc("measurement.monitoring.sample_period_millis", TimeChart.DAY);
        ...
        zzV = zzkgVarZzb.zzc("measurement.upload.stale_data_deletion_interval", TimeChart.DAY);
        ...
        zzai = zzkgVarZzb.zzc("measurement.upload.max_bundle_size", 65536L);
        ...
        zzar = zzkgVarZzb.zzc("measurement.upload.max_batch_size", 65536L);
