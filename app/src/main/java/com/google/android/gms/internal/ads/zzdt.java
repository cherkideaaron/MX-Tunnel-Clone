...
public final class zzdt implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public zzdt(Handler handler, zzds zzdsVar) {
        this.zzb = handler;
    }
    ...
    public final void zza(int i) throws zzdu {
        EGLSurface eGLSurfaceEglCreatePbufferSurface;
        EGLDisplay eGLDisplayEglGetDisplay = EGL14.eglGetDisplay(0);
        zzdv.zzf(eGLDisplayEglGetDisplay != null, "eglGetDisplay failed");
        int[] iArr = new int[2];
        zzdv.zzf(EGL14.eglInitialize(eGLDisplayEglGetDisplay, iArr, 0, iArr, 1), "eglInitialize failed");
        ...
        String str = zzfj.zza;
        zzdv.zzf(z, String.format(Locale.US, "eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", objArr));
        ...
        zzdv.zzf(eGLContextEglCreateContext != null, "eglCreateContext failed");
        ...
        if (i == 1) {
            ...
            zzdv.zzf(eGLSurfaceEglCreatePbufferSurface != null, "eglCreatePbufferSurface failed");
        }
        zzdv.zzf(EGL14.eglMakeCurrent(eGLDisplay, eGLSurfaceEglCreatePbufferSurface, eGLSurfaceEglCreatePbufferSurface, eGLContextEglCreateContext), "eglMakeCurrent failed");
