...
public final class zaaz extends GoogleApiClient implements zabu {
    ...
    private final void zam(int i) {
        ...
        if (num == null) {
            ...
            throw new IllegalStateException(AbstractC3264qG.m(new StringBuilder(strZag.length() + strZag2.length() + 51), "Cannot use sign-in mode: ", strZag2, ". Mode was already set to ", strZag));
        }
        if (this.zal != null) {
            return;
        }
        ...
        if (iIntValue != 1) {
            if (iIntValue == 2 && zRequiresSignIn) {
                zabdVar = zax.zaa(this.zan, this, this.zaj, this.zao, this.zat, map, this.zae, this.zaf, this.zag, this.zav);
            }
            this.zal = zabdVar;
        }
        if (!zRequiresSignIn) {
        ...
        zabdVar = new zabd(this.zan, this, this.zaj, this.zao, this.zat, map, this.zae, this.zaf, this.zag, this.zav, this);
        this.zal = zabdVar;
    }
