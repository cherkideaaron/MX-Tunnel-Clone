...
final class zziap extends zziaq {
    ...
    public /* synthetic */ zziap(InputStream inputStream, int i, byte[] bArr) {
        super(null);
    ...
    private final void zzO(int i) throws zzicg {
        if (zzP(i)) {
            return;
        }
        if (i <= (Api.BaseClientBuilder.API_PRIORITY_OTHER - this.zzl) - this.zzj) {
    ...
    private final boolean zzP(int i) throws IOException {
        ...
        int i4 = this.zzh;
        if (i3 <= i4) {
            throw new IllegalStateException(AbstractC3219pQ.e(new StringBuilder(String.valueOf(i).length() + 66), "refillBuffer() called when ", i, " bytes were already available in buffer"));
        }
        int i5 = this.zzl;
        if (i > (Api.BaseClientBuilder.API_PRIORITY_OTHER - i5) - i2 || i5 + i2 + i > this.zzm) {
            return false;
        }
        if (i2 > 0) {
            if (i4 > i2) {
        ...
        try {
            int i6 = this.zzf.read(this.zzg, i4, Math.min(4096 - i4, (Api.BaseClientBuilder.API_PRIORITY_OTHER - i5) - i4));
    ...
    public final String zzl() throws zzicg {
        ...
        if (iZzu > 0) {
            ...
            int i2 = this.zzj;
            if (iZzu <= i - i2) {
                String str = new String(this.zzg, i2, iZzu, zzice.zza);
                this.zzj += iZzu;
                return str;
            }
        }
    ...
    public final String zzm() throws IOException {
        ...
        return zzier.zze(bArrZzQ, i, iZzu);
    }
    ...
    public final zzian zzn() throws IOException {
        ...
        int i2 = this.zzj;
        if (iZzu <= i - i2 && iZzu > 0) {
            zzian zzianVarZzt = zzian.zzt(this.zzg, i2, iZzu, false);
            this.zzj += iZzu;
            return zzianVarZzt;
        }
        if (iZzu == 0) {
    ...
    @Override // com.google.android.gms.internal.ads.zziaq
    public final int zzz(int i) throws zzicg {
        if (i < 0) {
            throw new zzicg("CodedInputStream encountered an embedded string or message which claimed to have negative size.");
        }
