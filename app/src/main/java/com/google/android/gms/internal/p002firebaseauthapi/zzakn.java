...
public abstract class zzakn extends zzajw {
    ...
    public static class zza extends zzakn {
        ...
        public zza(byte[] bArr, int i, int i2) {
            ...
            if (((bArr.length - i2) | i2) < 0) {
                ...
                throw new IllegalArgumentException(AbstractC3264qG.e(bArr.length, i2, "Array range is invalid. Buffer.length=", ", offset=0, length="));
            }
            this.zzb = bArr;
            this.zzd = 0;
            this.zzc = i2;
        ...
        @Override // com.google.android.gms.internal.p002firebaseauthapi.zzakn
        public final void zzf(int i, long j) throws zzd {
            zzj(i, 1);
            zzf(j);
        }

        @Override // com.google.android.gms.internal.p002firebaseauthapi.zzakn
        public final void zzg(int i, int i2) throws zzd {
            zzj(i, 5);
            zzj(i2);
        }

        @Override // com.google.android.gms.internal.p002firebaseauthapi.zzakn
        public final void zzh(int i, int i2) throws zzd {
            zzj(i, 0);
            zzk(i2);
        }
        ...
        public final void zzm(int i) throws zzd {
            ...
            while ((i & (-128)) != 0) {
                ...
                try {
                    this.zzb[i3] = (byte) (i | UserVerificationMethods.USER_VERIFY_PATTERN);
                    i >>>= 7;
                    i3 = i2;
        ...
        @Override // com.google.android.gms.internal.p002firebaseauthapi.zzakn
        public final void zza(byte b) throws zzd {
            int i;
            int i2 = this.zzd;
            try {
                i = i2 + 1;
        ...
        @Override // com.google.android.gms.internal.p002firebaseauthapi.zzakn
        public final void zzf(long j) throws zzd {
            int i = this.zzd;
            try {
                byte[] bArr = this.zzb;
                bArr[i] = (byte) j;
        ...
        @Override // com.google.android.gms.internal.p002firebaseauthapi.zzakn
        public final void zzh(int i, long j) throws zzd {
            zzj(i, 0);
            zzh(j);
        }

        @Override // com.google.android.gms.internal.p002firebaseauthapi.zzakn
        public final void zzj(int i, int i2) throws zzd {
            zzm((i << 3) | i2);
        }

        @Override // com.google.android.gms.internal.p002firebaseauthapi.zzakn
        public final void zzk(int i, int i2) throws zzd {
            zzj(i, 0);
            zzm(i2);
        }

        private final void zzc(byte[] bArr, int i, int i2) throws zzd {
            try {
        ...
        public final void zza(byte[] bArr, int i, int i2) throws zzd {
            zzc(bArr, i, i2);
        }

        @Override // com.google.android.gms.internal.p002firebaseauthapi.zzakn
        public final void zzb(int i, boolean z) throws zzd {
            zzj(i, 0);
            zza(z ? (byte) 1 : (byte) 0);
        }

        @Override // com.google.android.gms.internal.p002firebaseauthapi.zzakn
        public final void zzh(long j) throws zzd {
            int i;
            int i2 = this.zzd;
            if (!zzakn.zzc || zza() < 10) {
                while ((j & (-128)) != 0) {
                    try {
                        int i3 = i2 + 1;
                        try {
                            this.zzb[i2] = (byte) (((int) j) | UserVerificationMethods.USER_VERIFY_PATTERN);
                            j >>>= 7;
                            i2 = i3;
                        } catch (IndexOutOfBoundsException e) {
                            e = e;
                ...
                while ((j & (-128)) != 0) {
                    zzanz.zza(this.zzb, i2, (byte) (((int) j) | UserVerificationMethods.USER_VERIFY_PATTERN));
                    j >>>= 7;
                    i2++;
                }
                i = i2 + 1;
        ...
        @Override // com.google.android.gms.internal.p002firebaseauthapi.zzakn
        public final void zzb(byte[] bArr, int i, int i2) throws zzd {
            zzm(i2);
            zzc(bArr, 0, i2);
        }
    }
        ...
        public final void zzj(long j) {
            if (!zzakn.zzc) {
                while ((j & (-128)) != 0) {
                    ...
                    int i = this.zzd;
                    this.zzd = i + 1;
                    bArr[i] = (byte) (((int) j) | UserVerificationMethods.USER_VERIFY_PATTERN);
                    this.zze++;
                    j >>>= 7;
                }
                byte[] bArr2 = this.zzb;
            ...
            while ((j & (-128)) != 0) {
                ...
                int i3 = this.zzd;
                this.zzd = i3 + 1;
                zzanz.zza(bArr3, i3, (byte) (((int) j) | UserVerificationMethods.USER_VERIFY_PATTERN));
                j >>>= 7;
            }
            byte[] bArr4 = this.zzb;
            int i4 = this.zzd;
        ...
        public final void zzo(int i) {
            if (!zzakn.zzc) {
                while ((i & (-128)) != 0) {
                    ...
                    int i2 = this.zzd;
                    this.zzd = i2 + 1;
                    bArr[i2] = (byte) (i | UserVerificationMethods.USER_VERIFY_PATTERN);
                    this.zze++;
                    i >>>= 7;
                }
                byte[] bArr2 = this.zzb;
            ...
            while ((i & (-128)) != 0) {
                ...
                int i4 = this.zzd;
                this.zzd = i4 + 1;
                zzanz.zza(bArr3, i4, (byte) (i | UserVerificationMethods.USER_VERIFY_PATTERN));
                i >>>= 7;
            }
            byte[] bArr4 = this.zzb;
            int i5 = this.zzd;
    ...
    public static class zzd extends IOException {
        ...
        private zzd(String str, Throwable th) {
            super(AbstractC3264qG.w("CodedOutputStream was writing to a flat byte array and ran out of space.: ", str), th);
        }
