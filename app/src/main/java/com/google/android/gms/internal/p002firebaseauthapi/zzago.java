...
final class zzago extends zzaie {
    ...
    public final String toString() {
        ...
        StringBuilder sbP = AbstractC3264qG.p("RevokeTokenRequest{providerId=", str, ", tenantId=", str2, ", token=");
        AbstractC3264qG.v(sbP, str3, ", tokenType=", strValueOf, ", idToken=");
        return AbstractC3264qG.l(sbP, str4, "}");
    }
