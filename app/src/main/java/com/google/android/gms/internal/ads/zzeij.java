...
final class zzeij extends zzeim {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof zzeim) {
            ...
            if (str != null ? str.equals(zzeimVar.zza()) : zzeimVar.zza() == null) {
                if (this.zzb.equals(zzeimVar.zzb())) {
                    Drawable drawable = this.zzc;
                    Drawable drawableZzc = zzeimVar.zzc();
                    if (drawable != null ? drawable.equals(drawableZzc) : drawableZzc == null) {
                        return true;
                    }
                }
            }
    ...
    public final String toString() {
        ...
        AbstractC3264qG.v(sb, "OfflineAdAssets{advertiserName=", str, ", imageUrl=", str2);
        return Vs.o(sb, ", icon=", strValueOf, "}");
    }
