...
public final class ObjectWrapper<T> extends IObjectWrapper.Stub {
    ...
    public static <T> T unwrap(IObjectWrapper iObjectWrapper) throws SecurityException {
        ...
        if (i != 1) {
            ...
            throw new IllegalArgumentException(AbstractC3264qG.k(new StringBuilder(String.valueOf(length).length() + 53), "Unexpected number of IObjectWrapper declared fields: ", length));
        }
