...
public final class zaar implements zaba {
    ...
    private final boolean zaI(int i) {
        ...
        Log.e("GACConnecting", AbstractC3264qG.m(new StringBuilder(strZaJ2.length() + strZaJ.length() + 70), "GoogleApiClient connecting is in step ", strZaJ, " but received callback for step ", strZaJ2), new Exception());
    ...
    public final /* synthetic */ void zaj(com.google.android.gms.signin.internal.zak zakVar) {
        if (zaI(0)) {
            ...
            this.zan = true;
            this.zao = (IAccountAccessor) Preconditions.checkNotNull(zayVar.zaa());
            this.zap = zayVar.zac();
            this.zaq = zayVar.zad();
            zak();
        }
    ...
    public final /* synthetic */ Set zap() {
        ...
        for (Api api : mapZaa.keySet()) {
            ...
            if (!zabdVar.zab.containsKey(api.zac())) {
                hashSet.addAll(((com.google.android.gms.common.internal.zae) mapZaa.get(api)).zaa);
            }
        }
        return hashSet;
    }
