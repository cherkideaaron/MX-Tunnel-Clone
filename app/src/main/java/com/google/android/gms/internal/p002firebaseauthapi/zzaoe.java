    ...
    public final int zza(String str, byte[] bArr, int i, int i2) {
        ...
        while (i6 < length) {
            ...
            if (cCharAt2 < 128 && i7 < i5) {
                ...
                i7 += 2;
                bArr[i8] = (byte) ((cCharAt2 & '?') | UserVerificationMethods.USER_VERIFY_PATTERN);
            } else {
                if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || i7 > i5 - 3) {
                    ...
                    if (i9 != str.length()) {
                        ...
                        if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                            ...
                            i7 += 4;
                            bArr[i10] = (byte) ((codePoint & 63) | UserVerificationMethods.USER_VERIFY_PATTERN);
                            i6 = i9;
                        } else {
                            i6 = i9;
                        }
                ...
                i7 += 3;
                bArr[i11] = (byte) ((cCharAt2 & '?') | UserVerificationMethods.USER_VERIFY_PATTERN);
            }
            i6++;
        }
        return i7;
    ...
    public final String zza(byte[] bArr, int i, int i2) throws zzall {
        ...
        while (i < i3) {
            ...
            if (b2 >= 0) {
                ...
                int i8 = i + 2;
                i += 3;
                zzaoc.zza(b2, bArr[i6], bArr[i8], cArr, i5);
                i5++;
            } else {
                if (i6 >= i3 - 2) {
                    throw zzall.zzd();
                ...
                byte b5 = bArr[i + 2];
                i += 4;
                zzaoc.zza(b2, b4, b5, bArr[i9], cArr, i5);
                i5 += 2;
            }
        }
