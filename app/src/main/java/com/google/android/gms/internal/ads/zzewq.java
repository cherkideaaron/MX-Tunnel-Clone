...
public final class zzewq implements zzikg {
    ...
    public final /* bridge */ /* synthetic */ Object zzb() {
        zzeue zzeueVarZzb = ((zzeug) this.zza).zzb();
        zzevl zzevlVar = (zzevl) this.zzb.zzb();
        List list = (List) this.zzc.zzb();
        ScheduledExecutorService scheduledExecutorService = (ScheduledExecutorService) this.zzd.zzb();
        if (list.contains("10")) {
            return new zzezj(zzevlVar, ((Integer) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zznD)).intValue(), scheduledExecutorService);
        }
        return new zzezj(zzeueVarZzb, ((Integer) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zznD)).intValue(), scheduledExecutorService);
    }
}
