...
public final class WakeLockEvent extends StatsEvent {
    ...
    public final String zzc() {
        ...
        int iF = Vs.f(length + 1, 1, str);
        if (str2 == null) {
            str2 = "";
        }
        int length2 = String.valueOf(f).length() + Vs.f(iF, 1, str2) + 1;
        String str5 = str3 != null ? str3 : "";
        StringBuilder sb = new StringBuilder(Vs.f(length2, 1, str5) + String.valueOf(z).length());
        sb.append("\t");
        sb.append(str4);
        sb.append("\t");
        sb.append(i2);
