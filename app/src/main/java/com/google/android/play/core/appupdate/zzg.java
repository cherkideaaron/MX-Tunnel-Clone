...
final class zzg implements AppUpdateManager {
    ...
    public final boolean startUpdateFlowForResult(AppUpdateInfo appUpdateInfo, @AppUpdateType int i, Activity activity, int i2) {
        ...
        return startUpdateFlowForResult(appUpdateInfo, new zzf(this, activity), appUpdateOptionsDefaultOptions, i2);
    }
    ...
    @Override // com.google.android.play.core.appupdate.AppUpdateManager
    public final boolean startUpdateFlowForResult(AppUpdateInfo appUpdateInfo, Q0 q0, AppUpdateOptions appUpdateOptions) {
        if (appUpdateInfo == null || q0 == null || appUpdateOptions == null || !appUpdateInfo.isUpdateTypeAllowed(appUpdateOptions) || appUpdateInfo.zzd()) {
            return false;
        }
        appUpdateInfo.zzc();
