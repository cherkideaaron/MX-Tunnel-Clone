...
public abstract class zznd<MessageType extends zznd<MessageType, BuilderType>, BuilderType extends zzmx<MessageType, BuilderType>> extends zzko<MessageType, BuilderType> {
    ...
    public final int zza(zzow zzowVar) {
        if (zzL()) {
            ...
            throw new IllegalStateException(Vs.k(iZza, "serialized size must be non-negative, was "));
        }
        ...
        if (iZza2 < 0) {
            throw new IllegalStateException(Vs.k(iZza2, "serialized size must be non-negative, was "));
        }
    ...
    public final int zzo() {
        ...
        if (zzL()) {
            iZzf = zzf(null);
            if (iZzf < 0) {
                throw new IllegalStateException(Vs.k(iZzf, "serialized size must be non-negative, was "));
            }
        } else {
            iZzf = this.zzd & Api.BaseClientBuilder.API_PRIORITY_OTHER;
