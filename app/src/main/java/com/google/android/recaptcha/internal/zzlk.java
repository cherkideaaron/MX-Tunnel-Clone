...
final class zzlk extends zzln {
    ...
    public final void zzt(int i) throws zzll {
        while ((i & (-128)) != 0) {
            try {
                ...
                int i2 = this.zzd;
                this.zzd = i2 + 1;
                bArr[i2] = (byte) ((i | UserVerificationMethods.USER_VERIFY_PATTERN) & 255);
                i >>>= 7;
            } catch (IndexOutOfBoundsException e) {
                throw new zzll(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), 1), e);
            }
    ...
    public final void zzv(long j) throws zzll {
        if (!zzln.zzc || this.zzc - this.zzd < 10) {
            while ((j & (-128)) != 0) {
                try {
                    ...
                    int i = this.zzd;
                    this.zzd = i + 1;
                    bArr[i] = (byte) ((((int) j) | UserVerificationMethods.USER_VERIFY_PATTERN) & 255);
                    j >>>= 7;
                } catch (IndexOutOfBoundsException e) {
                    throw new zzll(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), 1), e);
                }
        ...
        while (true) {
            ...
            int i5 = this.zzd;
            this.zzd = i5 + 1;
            zzps.zzn(bArr4, i5, (byte) ((i3 | UserVerificationMethods.USER_VERIFY_PATTERN) & 255));
            j >>>= 7;
        }
    }
}
