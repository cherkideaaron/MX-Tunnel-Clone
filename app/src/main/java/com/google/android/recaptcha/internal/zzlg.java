...
final class zzlg extends zzli {
    ...
    private final boolean zzM(int i) throws IOException {
        ...
        int i5 = this.zzk;
        if (i > (Api.BaseClientBuilder.API_PRIORITY_OTHER - i5) - i2 || i5 + i2 + i > this.zzl) {
            return false;
        }
        if (i2 > 0) {
            if (i4 > i2) {
        ...
        try {
            int i6 = this.zze.read(this.zzf, i4, Math.min(4096 - i4, (Api.BaseClientBuilder.API_PRIORITY_OTHER - i5) - i4));
