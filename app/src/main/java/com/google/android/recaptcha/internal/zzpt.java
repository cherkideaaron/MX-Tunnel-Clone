...
final class zzpt {
    public static /* bridge */ /* synthetic */ void zza(byte b, byte b2, byte b3, byte b4, char[] cArr, int i) throws zznn {
        if (!zze(b2)) {
    ...
    */
    public static /* bridge */ /* synthetic */ void zzb(byte r2, byte r3, byte r4, char[] r5, int r6) throws com.google.android.recaptcha.internal.zznn {
        /*
            boolean r0 = zze(r3)
            if (r0 != 0) goto L2c
            r0 = -96
    ...
    public static /* bridge */ /* synthetic */ void zzc(byte b, byte b2, char[] cArr, int i) throws zznn {
        if (b < -62 || zze(b2)) {
            throw new zznn("Protocol message had invalid UTF-8.");
        }
