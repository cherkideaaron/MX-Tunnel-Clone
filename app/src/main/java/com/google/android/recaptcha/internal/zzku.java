...
final class zzku {
    ...
    public static int zzh(int i, byte[] bArr, int i2, int i3, zzpm zzpmVar, zzkt zzktVar) throws zznn {
        ...
        if (i4 == 2) {
            ...
            zzpmVar.zzj(i, i5 == 0 ? zzle.zzb : zzle.zzk(bArr, iZzi, i5));
            return iZzi + i5;
        }
        if (i4 != 3) {
            if (i4 != 5) {
        ...
        while (true) {
            ...
            i2 = zzh(i8, bArr, iZzi2, i3, zzpmVarZzf, zzktVar);
        }
        zzktVar.zze--;
        if (i2 > i3 || i8 != i6) {
    ...
    public static int zzm(Object obj, zzow zzowVar, byte[] bArr, int i, int i2, int i3, zzkt zzktVar) throws zznn {
        ...
        zzktVar.zze = i4;
        zzq(i4);
        int iZzc = zzolVar.zzc(obj, bArr, i, i2, i3, zzktVar);
        zzktVar.zze--;
        zzktVar.zzc = obj;
        return iZzc;
    }
