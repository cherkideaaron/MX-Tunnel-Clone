    ...
    private final Object zzb(Object obj, Object obj2) throws zzce {
        ...
        if (obj instanceof String) {
            if (obj2 instanceof Byte) {
                ...
                return new String(AbstractC3383sa.g0(arrayList), AbstractC3202p9.a);
            }
        ...
        if (z9 && (obj2 instanceof Integer)) {
            ...
            return AbstractC3383sa.i0(arrayList11);
        }
        ...
        if (z7 && (obj2 instanceof byte[])) {
            ...
            C0283Pp c0283PpG0 = AbstractC0069Df.g0(0, length4);
            ArrayList arrayList15 = new ArrayList(AbstractC3491ua.Z(c0283PpG0, 10));
        ...
        if (z8 && (obj2 instanceof short[])) {
            ...
            C0283Pp c0283PpG02 = AbstractC0069Df.g0(0, length5);
            ArrayList arrayList16 = new ArrayList(AbstractC3491ua.Z(c0283PpG02, 10));
        ...
        if (z9 && (obj2 instanceof int[])) {
            ...
            C0283Pp c0283PpG03 = AbstractC0069Df.g0(0, length6);
            ArrayList arrayList17 = new ArrayList(AbstractC3491ua.Z(c0283PpG03, 10));
        ...
        if (z10 && (obj2 instanceof long[])) {
            ...
            C0283Pp c0283PpG04 = AbstractC0069Df.g0(0, length7);
            ArrayList arrayList18 = new ArrayList(AbstractC3491ua.Z(c0283PpG04, 10));
        ...
        if (z11 && (obj2 instanceof float[])) {
            ...
            C0283Pp c0283PpG05 = AbstractC0069Df.g0(0, length8);
            ArrayList arrayList19 = new ArrayList(AbstractC3491ua.Z(c0283PpG05, 10));
            Iterator it5 = c0283PpG05.iterator();
            while (((C0266Op) it5).c) {
                int iA5 = ((C0266Op) it5).a();
        ...
        C0283Pp c0283PpG06 = AbstractC0069Df.g0(0, length9);
        ArrayList arrayList20 = new ArrayList(AbstractC3491ua.Z(c0283PpG06, 10));
        Iterator it6 = c0283PpG06.iterator();
        while (((C0266Op) it6).c) {
            int iA6 = ((C0266Op) it6).a();
