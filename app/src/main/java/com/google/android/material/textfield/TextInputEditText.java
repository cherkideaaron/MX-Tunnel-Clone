...
public class TextInputEditText extends K2 {
    public final Rect m;
    public boolean n;

    public TextInputEditText(Context context, AttributeSet attributeSet) {
        super(AbstractC3279qd.n0(context, attributeSet, R.attr.editTextStyle, 0), attributeSet, 0);
        this.m = new Rect();
        int[] iArr = RA.E;
        AbstractC3279qd.k(context, attributeSet, R.attr.editTextStyle, R.style.Widget_Design_TextInputEditText);
        AbstractC3279qd.m(context, attributeSet, iArr, R.attr.editTextStyle, R.style.Widget_Design_TextInputEditText, new int[0]);
